export const SELF_ORDER_VI = {
  ...
  openBankingApp: "Mở ngân hàng",
  openMbBank: "Mở MB Bank",
  chooseOtherBank: "Chọn ngân hàng khác...",
  otherBankScanHint:
    "Ngân hàng khác: mở ứng dụng rồi quét mã QR trên màn hình này.",
  bankAppComingSoon: "Sắp hỗ trợ",
  chooseBankAppTitle: "Chọn ứng dụng ngân hàng",
  chooseBankAppDescription:
    "Chọn ứng dụng ngân hàng bạn đang dùng để chuyển khoản thanh toán.",
  searchBankPlaceholder: "Tìm ngân hàng (MB, VCB, BIDV, ACB...)",
  bankSearchEmpty: "Không tìm thấy ngân hàng phù hợp.",
