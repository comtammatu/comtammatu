...
export const FINANCE_VI = {
  ...
  invalidDownloadLink: "Link tải không hợp lệ",
  syncFailed: "Không thể đồng bộ hóa đơn",
  syncedStatusUpdated: "Đã đồng bộ — trạng thái cập nhật",
  syncNoUpdate: "Provider chưa có cập nhật — thử lại sau",
  syncStatusChangedReload: "Hóa đơn đã thay đổi trạng thái — tải lại trang",
  syncExpiredCancelled: "Hóa đơn quá hạn — đã chuyển sang 'đã hủy'",
  downloadPdf: "Tải PDF",
  downloadXml: "Tải XML",
  resyncWithProvider: "Đồng bộ lại với provider",
  resync: "Đồng bộ lại",
  sync: "Đồng bộ",
