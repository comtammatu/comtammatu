...
const itemVariants = cva(
  "group/item flex w-full flex-wrap items-center rounded-md border text-xs/relaxed transition-colors duration-[var(--motion-fast)] ease-[var(--ease-move)] outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-foreground [a]:transition-colors [a]:hover:bg-muted",
  {
    variants: {
      variant: {
