...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card surface-panel flex flex-col gap-4 py-4 text-sm text-card-foreground has-[>img:first-child]:pt-0 data-[size=sm]:gap-3 data-[size=sm]:py-3 *:[img:first-child]:rounded-t-3xl *:[img:last-child]:rounded-b-3xl",
        className
      )}
      {...props}
    />
