  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-md p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      ...
      layout: {
        ...
        scroll:
          "no-scrollbar flex w-full max-w-full justify-start gap-1 overflow-x-auto scroll-smooth",
      },
    },
    defaultVariants: {
      variant: "default",
...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      ...
      data-size={size}
      data-layout={layout}
      className={cn(tabsListVariants({ variant, size, layout }), className)}
      {...props}
    />
  );
}
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[layout=equal]/tabs-list:min-w-0 group-data-[layout=equal]/tabs-list:overflow-hidden group-data-[layout=equal]/tabs-list:px-2",
        "group-data-[layout=scroll]/tabs-list:flex-none group-data-[layout=scroll]/tabs-list:px-2.5",
