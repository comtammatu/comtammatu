...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 z-50 bg-effect-scrim transition-opacity duration-[var(--motion-fast)] ease-[var(--ease-move)] supports-backdrop-filter:backdrop-blur-xs data-[starting-style]:opacity-0 data-[ending-style]:opacity-0 data-[ending-style]:pointer-events-none",
        className,
      )}
      {...props}
    />
