...
export type SectionProps = AppSectionProps;
export const StationSection = AppSection;
export type StationSectionProps = AppSectionProps;
export const PublicSection = AppSection;
export type PublicSectionProps = AppSectionProps;

export type StationSectionHeadingLevel = AppSectionHeadingLevel;
export type PublicSectionHeadingLevel = AppSectionHeadingLevel;
