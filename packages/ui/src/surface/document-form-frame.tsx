...
import { AppPage, type AppPageProps } from "./page";
...
export const AppDocumentFormFrame = DocumentFormFrame;
export type AppDocumentFormFrameProps = DocumentFormFrameProps;
