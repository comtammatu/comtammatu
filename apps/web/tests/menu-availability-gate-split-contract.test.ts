...
const gateSplitMigration = readFileSync(
  join(
    process.cwd(),
    "../../supabase/migrations/20260705090000_menu_availability_gate_split.sql",
  ),
  "utf8",
);
...
const path2LockdownMigration = readFileSync(
  join(
    process.cwd(),
    "../../supabase/migrations/20260705091000_path2_lockdown_posting_idempotency.sql",
  ),
  "utf8",
);
...
const refundQuotaMigration = readFileSync(
  join(
    process.cwd(),
    "../../supabase/migrations/20260705092000_refund_quota_first_ready_boundary.sql",
  ),
  "utf8",
);
