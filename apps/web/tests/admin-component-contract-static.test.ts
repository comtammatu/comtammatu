...
test("UI contract guard freezes Admin Finance Branch component drift", () => {
  ...
  assert.match(designSystem, /focus-ring-contrast/);
  assert.match(designSystem, /radius-scale/);
  assert.match(designSystem, /radius-tier-baseline/);
  assert.match(designSystem, /gap-scale/);
  assert.match(designSystem, /primitive-radius-scale/);
  assert.match(designSystem, /primitive-transition-all/);
  assert.match(designSystem, /app-transition-all/);
  assert.match(designSystem, /native-interactive-element/);
  assert.match(designSystem, /icon-button-accessible-name/);
  assert.match(designSystem, /app-loading-spinner-ssot/);
  assert.match(designSystem, /root-viewport-allows-zoom/);
  assert.match(designSystem, /route-boundary-adapters/);
  assert.match(designSystem, /route-boundary-coverage/);
  assert.match(designSystem, /raw-empty-import-route-code/);
  assert.match(designSystem, /page-padding/);
  assert.match(designSystem, /button-height-on-button/);
  assert.match(designSystem, /operator-embedded-button-density/);
  assert.match(designSystem, /operator-embedded-page-header-boundary/);
  assert.match(designSystem, /operator-office-route-boundary/);
  assert.match(designSystem, /raw-table-element/);
  assert.match(designSystem, /surface-clone-ssot/);
  assert.match(designSystem, /primitive-runtime-arbitrary-px-rem-sizing/);
  assert.match(designSystem, /primitive-arbitrary-shadow/);
  assert.match(designSystem, /primitive-shadow-overrun/);
  assert.match(designSystem, /card-content-named-layout-props/);
  assert.match(designSystem, /card-content-classname-baseline/);
  assert.match(designSystem, /card-title-classname-baseline/);
  assert.match(designSystem, /app-section-content-named-layout-props/);
  assert.match(designSystem, /scrollarea-no-max-height-only/);
  assert.match(designSystem, /status-chip-wrapper-baseline/);
  assert.match(designSystem, /pos-kds-touch-reveal-baseline/);
  assert.match(designSystem, /space-y-baseline/);
  assert.match(designSystem, /raw-padding-baseline/);
  assert.match(designSystem, /gap-atypical-baseline/);
  assert.match(designSystem, /inline-chrome-baseline/);
  assert.match(designSystem, /hand-rolled-page-heading-baseline/);
  assert.match(designSystem, /hover-shadow-rung/);
  assert.match(designSystem, /app-effect-shadow-rung/);
  assert.match(designSystem, /resting-shadow-rung/);
  assert.match(designSystem, /resting-shadow-baseline/);
  assert.match(designSystem, /custom-shadow-baseline/);
  assert.match(designSystem, /motion-color-duration/);
  assert.match(designSystem, /app-presentation-state-copy/);
  assert.match(designSystem, /app-action-data-state-copy/);
  assert.doesNotMatch(designSystem, /app-action-data-state-copy-baseline/);
  assert.match(designSystem, /finance-page-local-formatter/);
  assert.match(designSystem, /app-page-local-number-formatter/);
  assert.match(designSystem, /vnd-format-ssot/);
  assert.match(designSystem, /date-format-ssot/);
  assert.match(designSystem, /status-label-ssot/);
  assert.match(designSystem, /stat-card-ssot/);
  assert.match(designSystem, /no-native-dialog/);
  assert.match(designSystem, /responsive-double-render/);
  assert.match(designSystem, /use-is-mobile-budget/);
  assert.match(designSystem, /shell-registry-bespoke-main/);
  assert.match(designSystem, /nav-shell-inline-literal/);
  assert.match(designSystem, /operator-office-shell-boundary/);
  assert.match(designSystem, /heading-scale/);
  assert.match(designSystem, /icon-size/);
  assert.match(designSystem, /uppercase-label-scale/);
  assert.match(designSystem, /app-arbitrary-sizing/);
  assert.match(designSystem, /tint-opacity/);
  assert.match(
    designSystem,
    /`AppDialog` for short non-form detail\/task overlays/,
  );
  assert.match(designSystem, /raw-\*-import-file-baseline/);
  assert.match(uiModule, /Má Tư Component Decision Matrix/);
  assert.match(uiModule, /Detail \/ task dialog/);
  assert.match(uiModule, /native interactive element/);
  assert.match(uiModule, /icon\/action\s+aria-label risk/);
  assert.match(uiModule, /loading spinner risk/);
  assert.match(uiModule, /route-local\s+state copy risk/);
  assert.match(uiModule, /app-presentation-state-copy/);
  assert.match(uiModule, /app-action-data-state-copy/);
  assert.doesNotMatch(uiModule, /app-action-data-state-copy-baseline/);
  assert.match(uiModule, /finance-page-local-formatter/);
  assert.match(uiModule, /app-page-local-number-formatter/);
  assert.match(uiModule, /vnd-format-ssot/);
  assert.match(uiModule, /date-format-ssot/);
  assert.match(uiModule, /status-label-ssot/);
  assert.match(uiModule, /stat-card-ssot/);
  assert.match(uiModule, /no-native-dialog/);
  assert.match(uiModule, /responsive-double-render/);
  assert.match(uiModule, /use-is-mobile-budget/);
  assert.match(uiModule, /shell-registry-bespoke-main/);
  assert.match(uiModule, /nav-shell-inline-literal/);
  assert.match(uiModule, /operator-office-shell-boundary/);
  assert.match(uiModule, /heading-scale/);
  assert.match(uiModule, /icon-size/);
  assert.match(uiModule, /uppercase-label-scale/);
  assert.match(uiModule, /app-arbitrary-sizing/);
  assert.match(uiModule, /tint-opacity/);
  assert.match(uiModule, /focus-ring-contrast/);
  assert.match(uiModule, /radius-scale/);
  assert.match(uiModule, /radius-tier-baseline/);
  assert.match(uiModule, /gap-scale/);
  assert.match(uiModule, /primitive-radius-scale/);
  assert.match(uiModule, /primitive-transition-all/);
  assert.match(uiModule, /app-transition-all/);
  assert.match(uiModule, /root-viewport-allows-zoom/);
  assert.match(uiModule, /route-boundary-adapters/);
  assert.match(uiModule, /route-boundary-coverage/);
  assert.match(uiModule, /raw-empty-import-route-code/);
  assert.match(uiModule, /page-padding/);
  assert.match(uiModule, /button-height-on-button/);
  assert.match(uiModule, /operator-embedded-button-density/);
  assert.match(uiModule, /operator-embedded-page-header-boundary/);
  assert.match(uiModule, /operator-office-route-boundary/);
  assert.match(uiModule, /raw-card-import-file-baseline/);
  assert.match(uiModule, /raw-alert-dialog-import-file-baseline/);
  assert.match(uiModule, /primitive-runtime-arbitrary-px-rem-sizing/);
  assert.match(uiModule, /primitive-arbitrary-shadow/);
  assert.match(uiModule, /primitive-shadow-overrun/);
  assert.match(uiModule, /card-content-named-layout-props/);
  assert.match(uiModule, /card-content-classname-baseline/);
  assert.match(uiModule, /card-title-classname-baseline/);
  assert.match(uiModule, /app-section-content-named-layout-props/);
  assert.match(uiModule, /scrollarea-no-max-height-only/);
  assert.match(uiModule, /raw-table-element/);
  assert.match(uiModule, /surface-clone-ssot/);
  assert.match(uiModule, /status-chip-wrapper-baseline/);
  assert.match(uiModule, /pos-kds-touch-reveal-baseline/);
  assert.match(uiModule, /space-y-baseline/);
  assert.match(uiModule, /raw-padding-baseline/);
  assert.match(uiModule, /gap-atypical-baseline/);
  assert.match(uiModule, /inline-chrome-baseline/);
  assert.match(uiModule, /hand-rolled-page-heading-baseline/);
  assert.match(uiModule, /hover-shadow-rung/);
  assert.match(uiModule, /app-effect-shadow-rung/);
  assert.match(uiModule, /resting-shadow-rung/);
  assert.match(uiModule, /resting-shadow-baseline/);
  assert.match(uiModule, /custom-shadow-baseline/);
  assert.match(uiModule, /motion-color-duration/);
...
test("UI component audit command stays wired for route-family drill-down", () => {
  ...
  assert.match(uiModule, /audit-to-guard map/);
  assert.match(uiModule, /Signal Guard Coverage/);
  assert.match(uiModule, /action height drift/);
  assert.match(uiModule, /surface clone risk/);
  assert.match(uiModule, /action\/data copy/);
  assert.match(designSystem, /audit-to-guard map/);
});
