...
VALUES
  ...
  ('procurement:invoice_create','inventory_procurement','Tạo hóa đơn NCC','either'),
  ('procurement:invoice_match','inventory_procurement','Đối chiếu hóa đơn NCC','either'),
  ('procurement:po_approve','inventory_procurement','Duyệt đơn đặt hàng NCC','either'),
  ('procurement:po_create','inventory_procurement','Tạo đơn đặt hàng NCC (PO)','either'),
  ...
  ('procurement:read','inventory_procurement','Xem đơn đặt hàng NCC','either'),
