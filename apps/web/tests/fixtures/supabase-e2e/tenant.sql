...
VALUES
  ...
  ('finance:targets_write','finance','Ghi chỉ tiêu doanh thu chi nhánh','tenant'),
  ...
  ('inventory:catalog_write','inventory','Thêm/sửa nguyên liệu và thang đơn vị quy đổi','tenant'),
...
CROSS JOIN (VALUES
  ...
  ('accountant', 'accountant', ARRAY['finance:ap_pay','finance:expense_approve','finance:expense_create','finance:targets_write','finance:view','procurement:invoice_create','procurement:invoice_match','procurement:po_approve','procurement:po_create','procurement:price_list_read','procurement:read']),
  ('central_supply_ops', 'central_supply_ops', ARRAY['hr:request_leave','inventory:adjust_approve','inventory:catalog_write','inventory:count_approve','inventory:count_assign','inventory:production_confirm','inventory:production_create','inventory:read','inventory:request_cancel','inventory:request_create','inventory:request_fulfill','inventory:request_submit','inventory:stocktake_complete','inventory:stocktake_create','inventory:stocktake_recount','inventory:stocktake_unblind','inventory:transfer_create','inventory:transfer_receive','inventory:transfer_ship','inventory:units_master','inventory:waste_approve','inventory:write','inventory:writeoff','procurement:grn_amend','procurement:grn_confirm','procurement:grn_create','procurement:invoice_create','procurement:invoice_match','procurement:po_approve','procurement:po_create','procurement:price_list_read','procurement:price_list_write','procurement:read','procurement:request_manage','procurement:supplier_manage','supplier_return:confirm','supplier_return:create','supplier_return:read']),
