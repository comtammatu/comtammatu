...
VALUES
  ...
  ('inventory:valuation_read','inventory','Read WAC and inventory valuation through the protected monetary boundary.','tenant'),
...
CROSS JOIN (VALUES
  ...
  ('accountant', 'accountant', ARRAY['finance:ap_pay','finance:expense_approve','finance:expense_create','finance:view','inventory:valuation_read','procurement:invoice_create','procurement:invoice_match','procurement:po_approve','procurement:po_create','procurement:price_list_read','procurement:read']),
  ('central_supply_ops', 'central_supply_ops', ARRAY['hr:request_leave','inventory:count_approve','inventory:count_assign','inventory:read','inventory:stocktake_complete','inventory:stocktake_create','inventory:stocktake_recount','inventory:waste_approve','inventory:write','inventory:writeoff','procurement:grn_confirm','procurement:grn_create','procurement:read','procurement:supplier_manage']),
