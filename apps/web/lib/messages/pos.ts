...
export const pos = {
  ...
  menu: {
    ...
    blockedStockExhausted: (itemName: string) =>
      `${itemName} đã hết nguyên liệu ở Bếp chi nhánh.`,
    blockedStockLow: (itemName: string, available: number) =>
      `${itemName} chỉ còn đủ nguyên liệu Bếp chi nhánh cho ${available} phần.`,
    ...
    manualLimitExceedsStock: (stock: number) =>
      `Giới hạn bán không được vượt Tồn Bếp chi nhánh (${stock}).`,
    stockCapacityRequired:
      "Chưa tính được Tồn Bếp chi nhánh để đặt Giới hạn bán.",
    capSourceManual: "Theo giới hạn bán",
    capSourceStock: "Theo Bếp chi nhánh/định mức",
    capSourceManualLower: "Giới hạn bán thấp hơn Tồn Bếp chi nhánh",
    capSourceStockLower: "Tồn Bếp chi nhánh thấp hơn giới hạn bán",
    capSourceEqual: "Giới hạn bán = Tồn Bếp chi nhánh",
    toggleDisabled: "Tắt",
    ...
    replenishKitchenTitle: "Bổ sung Bếp chi nhánh",
    replenishKitchenHint:
      "Chỉ dùng khi Bếp chi nhánh xác nhận còn phần thực tế.",
    replenishKitchenReasonLabel: "Lý do bổ sung",
    replenishKitchenReasonHint:
      "Lưu vào lịch sử điều chỉnh tồn Bếp chi nhánh.",
    replenishKitchenPlaceholder: "VD: Bếp còn 2 phần thực tế",
    replenishKitchenReasonMin: "Nhập lý do bổ sung tối thiểu 5 ký tự.",
    replenishKitchenFailed: "Không thể bổ sung Bếp chi nhánh.",
    replenishKitchenSuccess: (itemName: string, extraPortions: number) =>
      `Đã bổ sung Bếp chi nhánh: ${itemName} +${extraPortions} suất`,
