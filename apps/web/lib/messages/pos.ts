export const pos = {
  ...
  appendDraft: {
    title: "Món thêm",
    closeAria: "Đóng món thêm",
    cancelAria: "Hủy thêm món",
    empty: "Chưa có món thêm",
    listAria: "Món sẽ gửi thêm",
    editItemAria: (name: string) => `Sửa ${name} trong món thêm`,
    removeItemAria: (name: string) => `Xóa ${name} khỏi món thêm`,
  ...
  archivedOrders: {
    ...
    description: "Danh sách hóa đơn đã thanh toán hoặc đã hủy.",
  ...
  tableGate: {
    ...
    multiBill: (count: number) => `${count} hóa đơn`,
