...
export const pos = {
  ...
  menu: {
    ...
    replenishWarehouseTitle: "Bổ sung tồn kho",
    replenishWarehouseHint:
      "Chỉ dùng khi kho chi nhánh xác nhận còn phần thực tế.",
    replenishWarehouseReasonLabel: "Lý do bổ sung",
    replenishWarehouseReasonHint:
      "Lưu vào lịch sử điều chỉnh tồn kho chi nhánh.",
    replenishWarehousePlaceholder: "VD: Kho còn 2 phần thực tế",
    replenishWarehouseReasonMin: "Nhập lý do bổ sung tối thiểu 5 ký tự.",
    replenishWarehouseFailed: "Không thể bổ sung tồn kho.",
    replenishWarehouseSuccess: (itemName: string, extraPortions: number) =>
