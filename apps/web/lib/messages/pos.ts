export const pos = {
  ...
  menu: {
    ...
    blockedStockExhausted: (itemName: string) =>
      `${itemName} đã hết nguyên liệu ở Bếp CN.`,
    blockedStockLow: (itemName: string, available: number) =>
      `${itemName} chỉ còn đủ nguyên liệu Bếp CN cho ${available} phần.`,
    ...
    stockCapacityLabel: "Tồn Bếp CN",
    stockCapacityEmpty: "—",
    itemCount: (quantity: number) => `${quantity} món`,
    limitedCount: (quantity: number) => `${quantity} có giới hạn`,
    stockCapacityCount: (quantity: number) => `${quantity} có tồn Bếp CN`,
    ...
    manualLimitExceedsStock: (stock: number) =>
      `Giới hạn bán không được vượt Tồn Bếp CN (${stock}).`,
    stockCapacityRequired: "Chưa tính được Tồn Bếp CN để đặt Giới hạn bán.",
    capSourceManual: "Theo giới hạn bán",
    capSourceStock: "Theo Bếp CN/định mức",
    capSourceManualLower: "Giới hạn bán thấp hơn Tồn Bếp CN",
    capSourceStockLower: "Tồn Bếp CN thấp hơn giới hạn bán",
    capSourceEqual: "Giới hạn bán = Tồn Bếp CN",
    toggleDisabled: "Tắt",
    ...
    replenishKitchenTitle: "Bổ sung Bếp CN",
    replenishKitchenHint: "Chỉ dùng khi Bếp CN xác nhận còn phần thực tế.",
    replenishKitchenReasonLabel: "Lý do bổ sung",
    replenishKitchenReasonHint: "Lưu vào lịch sử điều chỉnh tồn Bếp CN.",
    replenishKitchenPlaceholder: "VD: Bếp còn 2 phần thực tế",
    replenishKitchenReasonMin: "Nhập lý do bổ sung tối thiểu 5 ký tự.",
    replenishKitchenFailed: "Không thể bổ sung Bếp CN.",
    replenishKitchenSuccess: (itemName: string, extraPortions: number) =>
      `Đã bổ sung Bếp CN: ${itemName} +${extraPortions} suất`,
