export const pos = {
  ...
  menu: {
    ...
    stockCapacityLabel: "Tồn kho",
    stockCapacityEmpty: "—",
    itemCount: (quantity: number) => `${quantity} món`,
    limitedCount: (quantity: number) => `${quantity} có giới hạn`,
    stockCapacityCount: (quantity: number) => `${quantity} có tồn kho`,
    ...
    manualLimitExceedsStock: (stock: number) =>
      `Giới hạn bán không được vượt Tồn kho (${stock}).`,
    stockCapacityRequired: "Chưa tính được Tồn kho để đặt Giới hạn bán.",
    capSourceManual: "Theo giới hạn bán",
    capSourceStock: "Theo kho/định mức",
    capSourceManualLower: "Giới hạn bán thấp hơn tồn kho",
    capSourceStockLower: "Tồn kho thấp hơn giới hạn bán",
    capSourceEqual: "Giới hạn bán = tồn kho",
    toggleDisabled: "Tắt",
