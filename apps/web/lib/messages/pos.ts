export const pos = {
  ...
  menu: {
    ...
    menuLimitsEmptyDescription:
      "Thêm món trước khi cấu hình hạn mức bán trong ngày.",
    ...
    soldLabel: "Đã bán",
    totalLimitLabel: "Tổng suất",
    manualLimitLabel: "Trần thủ công",
    stockCapacityLabel: "Phần bán được",
    stockCapacityEmpty: "—",
    itemCount: (quantity: number) => `${quantity} món`,
    limitedCount: (quantity: number) => `${quantity} trần thủ công`,
    stockCapacityCount: (quantity: number) => `${quantity} có phần bán được`,
    ...
    soldProgressAria: (sold: number, limit: number) =>
      `Đã bán ${sold} trên ${limit} suất`,
    limitInputAria: (name: string) => `Hạn mức ${name}`,
    totalLimitInputAria: (name: string) => `Tổng suất ${name}`,
    manualLimitInputAria: (name: string) => `Trần thủ công ${name}`,
    capSourceManual: "Theo trần thủ công",
    capSourceStock: "Theo kho/định mức",
    capSourceManualLower: "Trần thủ công thấp hơn kho",
    capSourceStockLower: "Kho/định mức thấp hơn trần",
    capSourceEqual: "Trần thủ công = kho",
    toggleDisabled: "Tắt",
