...
export const pos = {
  ...
  menu: {
    ...
    stockAllowanceHint:
      "Cộng thêm số phần lên trên tồn quy đổi hôm nay. Không ghi sổ kho.",
    ...
    stockAllowanceSaveFailed: "Không lưu được số phần bán thêm.",
    stockAllowanceUpdated: (itemName: string, portions: number) =>
      `Đã cho phép bán thêm ${portions} phần: ${itemName}`,
