...
export const pos = {
  ...
  menu: {
    ...
    manualLimitOptionalHint:
      "Tổng suất trong ngày (để trống = không giới hạn).",
    ...
    drawerDescription: "Cấu hình trần suất bán và bán vượt tồn.",
    clearLimit: "Bỏ",
    ...
    stockAllowanceLabel: "Bán vượt tồn",
    stockAllowanceHint: "Bật để bán tiếp khi hết tồn kho.",
    stockAllowanceAria: (name: string) => `Bán vượt tồn ${name}`,
    ...
    stockAllowanceSaveFailed: "Không lưu được cấu hình bán vượt tồn.",
    stockAllowanceUpdated: (itemName: string) =>
      `Đã bật bán vượt tồn: ${itemName}`,
    stockAllowanceCleared: (itemName: string) =>
      `Đã tắt bán vượt tồn: ${itemName}`,
    stockAllowanceClear: "Tắt bán vượt tồn",
    sellingOnAllowance: "Đang bán vượt tồn",
