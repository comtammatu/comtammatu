...
export const settings = {
  ...
  branch: {
    ...
    closeDayTitle: "Chốt ngày",
    closeDayDescription: "Tổng hợp doanh thu, quỹ và ca POS của ngày.",
    ...
    closeDayNoteLabel: "Ghi chú chốt ngày",
    closeDayNotePlaceholder: "Tuỳ chọn — ghi chú cho lần chốt này",
    closeDaySubmit: "Chốt ngày",
    closeDayConfirmTitle: "Xác nhận chốt ngày",
    closeDayConfirmDescription:
      "Sau khi chốt, ngày này không thể mở lại. Hãy chắc chắn mọi ca POS đã đóng và quỹ đã đối soát.",
    closeDayAlreadyClosed: "Ngày đã chốt",
    closeDayClosedAt: "Đã chốt lúc",
    closeDayLoadFailedTitle: "Không tải được dữ liệu chốt ngày",
    closeDayLoadFailedBody: "Vui lòng thử lại sau.",
    closeDayNoSessions: "Chưa có ca POS nào trong ngày",
    closeDaySuccessToast: "Đã chốt ngày",
    closeDayErrorToast: "Không thể chốt ngày",
    closeDayStep1Title: "Đóng ca POS & Kiểm két tiền mặt",
    closeDayStep1Desc: "Đảm bảo 100% các phiên bán hàng POS đã kiểm két và đóng ca.",
    closeDayStep1Success: "Toàn bộ phiên POS trong ngày đã đóng và kiểm két thành công.",
    closeDayStep2Title: "Kiểm tra Duyệt kho & Hao hụt cuối ngày",
    closeDayStep2Desc: "Rà soát các phiếu đếm kho và phiếu hủy/hao hụt nguyên liệu.",
    ...
    closeDayPendingCountSlipsText: (count: number) =>
      count > 0 ? `Còn ${count} phiếu chờ duyệt` : "Không có phiếu đọng",
    closeDayStep3Title: "Duyệt ca làm việc & Giờ công nhân sự",
    closeDayStep3Desc: "Đảm bảo tất cả nhân viên đã kết ca và được duyệt giờ công.",
    ...
    closeDayStep4Title: "Xác nhận Tổng quan Doanh thu & Chốt sổ ngày",
    closeDayStep4Desc: "Rà soát số liệu doanh thu và xác nhận chốt sổ ngày vận hành.",
