...
export const settings = {
  ...
  pages: {
    ...
    holidaySurchargesTitle: "Phụ thu ngày lễ",
    holidaySurchargesDescription:
      "Lập lịch phụ thu tự động theo toàn hệ thống hoặc từng chi nhánh; khoản này không tính vào doanh thu và không gửi lên HĐĐT.",
  ...
  holidaySurcharges: {
    sectionTitle: "Lịch phụ thu",
    sectionDescription:
      "Chính sách theo chi nhánh được ưu tiên hơn chính sách toàn hệ thống. Đơn đã tạo giữ nguyên chính sách tại thời điểm tạo.",
    add: "Thêm lịch phụ thu",
    createTitle: "Thêm lịch phụ thu ngày lễ",
    editTitle: "Chỉnh sửa lịch phụ thu ngày lễ",
    formDescription:
      "Thời gian nhập theo giờ Việt Nam. Mốc kết thúc không còn áp dụng phụ thu.",
    create: "Tạo lịch",
    update: "Lưu thay đổi",
    created: "Đã tạo lịch phụ thu",
    updated: "Đã cập nhật lịch phụ thu",
    emptyTitle: "Chưa có lịch phụ thu",
    emptyDescription:
      "Tạo lịch để POS tự áp dụng phụ thu cho đơn mới trong khoảng thời gian đã chọn.",
    nameLabel: "Tên chính sách",
    namePlaceholder: "VD: Tết Nguyên Đán 2027",
    scopeLabel: "Phạm vi áp dụng",
    tenantScope: "Tất cả chi nhánh",
    calculationTypeLabel: "Cách tính",
    percentage: "Theo phần trăm",
    fixed: "Số tiền cố định",
    valuePercentageLabel: "Tỷ lệ phụ thu (%)",
    valueFixedLabel: "Số tiền phụ thu (đ)",
    percentageHelp:
      "Tính trên tổng HĐĐT sau giảm giá, trước khi cộng phụ thu ngày lễ.",
    fixedHelp: "Cộng cùng một số tiền vào mỗi đơn thuộc lịch này.",
    startsAtLabel: "Bắt đầu",
    endsAtLabel: "Kết thúc",
    stateLabel: "Trạng thái cấu hình",
    enabled: "Bật áp dụng",
    disabled: "Tạm tắt",
    activeNow: "Đang áp dụng",
    upcoming: "Sắp áp dụng",
    ended: "Đã kết thúc",
    inactive: "Đang tắt",
    scope: (name: string) => `Phạm vi: ${name}`,
    period: (start: string, end: string) => `${start} → ${end}`,
    edit: "Chỉnh sửa",
    deactivate: "Tạm tắt",
    activate: "Bật lại",
    activated: "Đã bật lịch phụ thu",
    deactivated: "Đã tắt lịch phụ thu",
    invalid: "Dữ liệu lịch phụ thu không hợp lệ.",
    invalidTime: "Khoảng thời gian phụ thu không hợp lệ.",
    overlap:
      "Khoảng thời gian này chồng với một lịch đang bật trong cùng phạm vi.",
    saveFailed: "Không thể lưu lịch phụ thu. Vui lòng thử lại.",
    toggleFailed: "Không thể đổi trạng thái lịch phụ thu. Vui lòng thử lại.",
    loadFailed: "Không thể tải lịch phụ thu. Vui lòng thử lại.",
  },
  payments: {
