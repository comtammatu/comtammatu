export const settings = {
  ...
  attendance: {
    ...
    secretTitle: "Mã kết ca",
    generateNewSecret: "Tạo mã mới",
    generateSecret: "Tạo mã kết ca",
    showTodayCode: "Xem mã hôm nay",
    codeTitle: (date: string | null) => `Mã kết ca — ${date ?? ""}`,
    codeDescription:
      "Dùng mã này để nhân viên kết ca tại chi nhánh. Mã thay đổi mỗi ngày.",
