...
export const owner = {
  dashboard: {
    ...
    title: "Hôm nay",
    description: "Việc cần xử lý theo quyền của bạn, rồi vào đúng mô-đun.",
    ...
    shortcutsTitle: "Mô-đun",
    shortcutsDescription: "Vào nhanh các mảng bạn được phép làm việc.",
    financeDescription: "Dòng tiền, thu chi, đối soát và báo cáo tài chính.",
    ordersDescription: "Theo dõi đơn bán và xử lý ngoại lệ bán hàng.",
