...
export const INVENTORY_ERROR_CODES = {
  ...
  ISSUE_CREATE_FAILED: "inventory.issue.create_failed",
  ISSUE_NUMBER_FAILED: "inventory.issue.number_failed",
  ISSUE_LOCATION_LOOKUP_FAILED: "inventory.issue.location_lookup_failed",
  ISSUE_LOCATION_NOT_CONFIGURED: "inventory.issue.location_not_configured",
  ISSUE_LOCATION_AMBIGUOUS: "inventory.issue.location_ambiguous",
