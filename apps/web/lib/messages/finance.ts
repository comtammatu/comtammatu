...
export const finance = {
  ...
  basic: {
    ...
    kpis: {
      ...
      vatInput: "Đầu vào",
      vatInputHint: "Hóa đơn NCC + chi phí vận hành · chưa mặc định được khấu trừ.",
      vatOutput: "Đầu ra",
  ...
  supplierInvoicesPage: {
    ...
    noAccessDescription: "Cần quyền xem đơn đặt hàng NCC.",
  ...
  foodCost: {
    ...
    unitFoodCostCurrency: "Giá vốn định mức/món (₫)",
