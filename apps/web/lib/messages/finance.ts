...
export const finance = {
  ...
  revenueTargets: {
    page: {
      ...
      description:
        "Nhập một chỉ tiêu tháng cho từng chi nhánh. Chỉ tiêu tính trên Doanh thu thuần: giá trị món đã thanh toán sau giảm giá, chưa bao gồm thuế giá trị gia tăng.",
    },
    monthLabel: "Tháng",
    applyMonth: "Áp dụng",
    add: "Thêm chỉ tiêu",
    ...
    deleteConfirm: "Thao tác này xoá chỉ tiêu và các mốc thưởng của tháng đang xem.",
    deleteCancel: "Huỷ",
    ...
    editor: {
      ...
      description: "Chỉ tiêu tháng tính trên Doanh thu thuần, chưa bao gồm thuế giá trị gia tăng.",
