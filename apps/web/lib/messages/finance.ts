...
export const finance = {
  ...
  nav: {
    ...
    items: {
      ...
      costClose: "Khóa kỳ giá vốn",
    },
  },
  costClose: {
    title: "Khóa kỳ giá vốn",
    description:
      "Đối soát tồn kho, quyết toán giá mua và khóa sổ quản trị theo tháng.",
    month: "Tháng",
    apply: "Xem kỳ",
    prepare: "Chuẩn bị sổ giá trị",
    preparing: "Đang chuẩn bị…",
    activate: "Kích hoạt sổ giá trị",
    ...
    noBlockers: "Không có điểm chặn kỹ thuật hoặc giá trị.",
    noReconciliation: "Chưa có số đối soát.",
    currentInventoryValue: "Giá trị tồn hiện tại",
    confirmedPurchaseValue: "Giá mua ròng đã xác nhận",
    waiverLabel: "Lý do chấp nhận điểm cần xác nhận",
    waiverPlaceholder: "Nhập lý do để lưu cùng biên bản khóa kỳ",
    noWaiverNeeded: "Kỳ này không có điểm cần xác nhận.",
    prepareSuccess: "Đã tạo giá trị mở sổ và bắt đầu đối chiếu song song.",
    activateSuccess: "Đã kích hoạt sổ giá trị tồn kho.",
    closeSuccess: "Đã khóa kỳ giá vốn.",
    loadFailed: "Không thể tải đối soát kỳ giá vốn.",
    prepareFailed: "Không thể chuẩn bị sổ giá trị tồn kho.",
    activateFailed: "Không thể kích hoạt sổ giá trị tồn kho.",
    closeFailed: "Không thể khóa kỳ giá vốn.",
    noAccess: "Chỉ Chủ hệ thống có quyền khóa kỳ giá vốn.",
  },
  revenueTargets: {
    page: {
      title: "Chỉ tiêu doanh thu tháng",
      description:
        "Đặt chỉ tiêu Doanh thu thuần theo tháng cho từng chi nhánh.",
    },
    monthLabel: "Tháng",
    applyMonth: "Áp dụng",
    save: "Lưu chỉ tiêu",
    saving: "Đang lưu…",
    saved: (count: string) => `Đã lưu ${count} chỉ tiêu.`,
    branch: "Chi nhánh",
    target: "Chỉ tiêu (VND)",
  ...
  supplierInvoicesPage: {
    ...
    description: "Thuế GTGT theo chứng từ · chưa mặc định được khấu trừ.",
