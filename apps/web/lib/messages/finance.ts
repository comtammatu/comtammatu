...
export const finance = {
  ...
  bankTransactions: {
    ...
    reconciliation: {
      matched: "Đã khớp",
      matchedHint: "Đã nối vào đơn hàng, khoản chi, hoặc thanh toán NCC.",
    ...
    unmatchedMoneyOutListDescription:
      "Giao dịch tiền ra chưa gắn khoản chi hoặc thanh toán NCC.",
    ...
    matchedSupplierPayment: (id: number | string) => `Thanh toán NCC #${id}`,
    matchedSupplierPaymentDetail: (supplier: string, invoice: string) =>
      `${supplier} · ${invoice}`,
    supplierPaymentLink: {
      addAction: "Gắn thanh toán NCC",
      editAction: "Sửa gắn thanh toán NCC",
      title: "Gắn thanh toán NCC",
      description:
        "Chọn một hoặc nhiều khoản thanh toán NCC có tổng tiền bằng sao kê.",
      bankAmount: "Sao kê",
      selectedAmount: "Đã chọn",
      delta: "Còn lệch",
      paymentDate: "Ngày thanh toán",
      noReference: "Không có mã",
      noCandidates: "Không có khoản thanh toán NCC chưa gắn trong kỳ này.",
      amountMismatch: "Tổng đã chọn phải bằng số tiền trên sao kê.",
      saveAction: "Lưu gắn",
      clearAction: "Bỏ gắn thanh toán NCC",
      savePending: "Đang lưu",
      saveSuccess: "Đã cập nhật thanh toán NCC của giao dịch.",
      clearSuccess: "Đã bỏ gắn thanh toán NCC.",
      errors: {
        forbidden: "Chỉ chủ cửa hàng có quyền gắn thanh toán NCC.",
        notReady: "Chức năng gắn thanh toán NCC chưa sẵn sàng.",
        evidenceChanged:
          "Giao dịch hoặc thanh toán NCC đã thay đổi. Hãy làm mới trang.",
        amountMismatch: "Tổng thanh toán NCC phải bằng số tiền trên sao kê.",
        eventUnavailable:
          "Giao dịch này không còn đủ điều kiện gắn thanh toán NCC.",
        actionError: "Không thể cập nhật thanh toán NCC.",
      },
    },
