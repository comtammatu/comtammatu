export const finance = {
  ...
  cashBook: {
    ...
    description:
      "Ghi nhận tiền thu / chi của quán theo ngày — theo dõi quỹ thay cho Excel.",
    addEntry: "Ghi sổ",
    dialogTitle: "Ghi sổ quỹ",
    dialogDescription: "Thêm một khoản thu hoặc chi tiền mặt.",
    directionIn: "Thu (tiền vào)",
    directionOut: "Chi (tiền ra)",
    badgeIn: "Thu",
    badgeOut: "Chi",
    fields: {
      branch: "Chi nhánh",
    ...
    notePlaceholder: "VD: Mua rau chợ sáng",
    totals: {
      in: "Tổng thu",
      out: "Tổng chi",
      balance: "Chênh lệch kỳ",
    },
    table: {
      date: "Ngày",
      direction: "Loại",
    ...
    empty: "Chưa có khoản thu/chi nào trong kỳ.",
    emptyHint: 'Bấm "Ghi sổ" để thêm khoản đầu tiên.',
    chooseBranch: "Chọn chi nhánh trước khi ghi sổ.",
    success: "Đã ghi sổ quỹ.",
  },
  shell: {
    subLabel: "Vận hành",
    mainLabel: "Tài chính",
