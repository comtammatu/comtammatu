export const finance = {
  ...
  basic: {
    ...
    kpis: {
      ...
      netProfitHint: (gross: string, expense: string) =>
  ...
  expenses: {
    page: {
      ...
      title: "Chi vận hành",
      description:
        "Sổ chi phí vận hành ngoài nhà cung cấp: thuê mặt bằng, điện nước, gas, lương, sửa chữa. Tổng chi trong kỳ trừ thẳng vào lợi nhuận ròng.",
    },
    add: "Thêm chi phí",
    ...
    empty: {
      ...
      description:
        "Thêm khoản chi vận hành để theo dõi lợi nhuận ròng và tiền mặt.",
    },
    form: {
      title: "Thêm chi phí vận hành",
      date: "Ngày chi",
      branch: "Chi nhánh",
    ...
    table: {
      ...
      deleteFailed: "Không thể xóa chi phí",
    },
    categoryLabels: {
      rent: "Thuê mặt bằng",
      utilities: "Điện / nước",
      ...
      salary: "Lương (tạm)",
      cogs_manual: "Nguyên liệu mua ngoài",
  ...
  cash: {
    onHandTitle: "Tiền mặt hiện hữu",
    setOpening: "Đặt tồn quỹ",
    editOpening: "Cập nhật tồn quỹ",
    noOpening:
      "Đặt tồn quỹ đầu kỳ (đếm tiền mặt thực tế tại một ngày) để theo dõi tiền mặt hiện hữu.",
    onHandBreakdown: (
      opening: string,
      date: string,
      cashIn: string,
    ...
    cashProfitTitle: "Lợi nhuận thực tế (tiền mặt)",
    cashProfitHint: (net: string) =>
      `Tiền thực thu − chi đã trả · lợi nhuận ròng ${net}`,
    openingTitle: "Tồn quỹ tiền mặt đầu kỳ",
    openingDescription:
      "Đếm tiền mặt thực tế tại một ngày làm mốc. Hệ cộng tiền mặt thu và trừ chi tiền mặt từ ngày này để ra tiền mặt hiện hữu.",
