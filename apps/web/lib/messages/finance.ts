...
export const finance = {
  ...
  basic: {
    ...
    exceptions: {
      ...
      periodStatusLabels: {
        open: "Sổ kỳ đang mở",
        soft_closed: "Đã chốt mềm",
        hard_closed: "Đã khóa sổ",
      },
      periodStatusPrefix: "Trạng thái sổ:",
      closeSoftButton: "Chốt sổ kỳ",
      closeHardButton: "Khóa sổ hoàn toàn",
      reopenButton: "Mở lại sổ kỳ",
      closeBlockedTooltip: "Còn lỗi chặn, hãy xử lý hết các mục chặn trước khi chốt sổ.",
      softCloseConfirmTitle: "Xác nhận chốt sổ kỳ",
      softCloseConfirmDesc: (month: number, year: number) =>
        `Chốt mềm kỳ tháng ${month}/${year}? Các cảnh báo đã được ghi nhận.`,
      hardCloseConfirmTitle: "Xác nhận khóa sổ hoàn toàn",
      hardCloseConfirmDesc: (month: number, year: number) =>
        `Khóa sổ kỳ tháng ${month}/${year}? Sau khi khóa, toàn bộ phiếu kho của kỳ này sẽ bị chặn sửa đổi.`,
      reopenConfirmTitle: "Mở lại sổ kỳ",
      reopenConfirmDesc: (month: number, year: number) =>
        `Mở lại kỳ tháng ${month}/${year}. Hãy nhập lý do mở lại để lưu nhật ký kiểm toán.`,
      reopenReasonLabel: "Lý do mở lại sổ",
      reopenReasonPlaceholder: "Nhập lý do cần mở lại kỳ...",
      reopenReasonMinLength: "Lý do phải có ít nhất 10 ký tự.",
      readinessCodes: {
        ...
        unposted_labor_cost: "Chưa kết chuyển chi phí nhân sự",
    ...
    laborCost: {
      ...
      description: "Tổng lương và bảo hiểm từ bảng lương đã chốt trong tháng.",
      laborCostRatio: "Tỷ lệ nhân công / Doanh thu",
      ratioSafe: "An toàn",
      ratioHigh: "Cao hơn định mức",
      totalCost: "Tổng chi phí lương",
      employerInsurance: "Bảo hiểm công ty nộp",
      grossSalary: "Tổng lương gộp",
      statusPosted: "Đã kết chuyển vào chi phí",
      statusNotPosted: "Chưa kết chuyển vào chi phí",
      statusNoPayroll: "Chưa có bảng lương chốt",
      postAction: "Kết chuyển chi phí",
      postConfirmTitle: "Kết chuyển chi phí nhân sự vào KQKD",
      postConfirmDesc: (month: number, year: number) =>
        `Tạo dòng chi phí vận hành (lương) cho kỳ tháng ${month}/${year} theo từng chi nhánh?`,
      postSuccess: "Đã kết chuyển chi phí nhân sự vào chi phí vận hành.",
      postFailed: "Không thể kết chuyển chi phí nhân sự.",
      viewExpenses: "Xem chi phí →",
      branchBreakdownTitle: "Phân bổ chi phí nhân sự theo chi nhánh",
      employeeCount: (count: number) => `${count} nhân sự`,
      postedBadge: "Đã ghi",
      pendingBadge: "Chờ ghi",
    },
  },
  nav: {
    groups: {
  ...
  expenses: {
    ...
    form: {
      ...
      noteCalloutTitle: "Ghi nhận nhật ký chi phí đã chi",
      noteCalloutDescription:
        "Dành cho chi phí vận hành (điện, nước, lương, mặt bằng) hoặc vốn thi công, tài sản đã chi trả thực tế. Mua nguyên liệu nấu món (thịt sườn, gạo, rau) vui lòng nhập tại Hóa đơn đầu vào (Nhập kho).",
      date: "Ngày phát sinh",
      branch: "Nơi chi",
      ...
      note: "Nội dung chi",
      notePlaceholder: "Nhập mục đích hoặc nội dung khoản chi thực tế",
      vatSection: "Chi tiết số tiền & Thuế",
      vatSectionHint: "Tổng tiền đã gồm thuế GTGT theo hóa đơn.",
      lineTotal: "Tổng tiền",
      lineVatRate: "Thuế suất",
      lineVatAmount: "Thuế GTGT",
      addLine: "Thêm dòng thuế",
      removeLine: "Xóa dòng",
      vatAutoPlaceholder: "Tự tính nếu bỏ trống",
      ...
      submit: "Lưu khoản chi đã thực hiện",
    ...
    paymentMethodLabels: {
      cash: "Tiền mặt (Trừ két chi nhánh)",
      transfer: "Chuyển khoản (Từ tài khoản NH)",
      unpaid: "Ghi nợ (Chưa chi / Tạm tính)",
    },
  },
  equipment: {
    page: {
