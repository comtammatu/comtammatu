...
export const hr = {
  ...
  client: {
    ...
    offboarding: {
      ...
      invalidDate: "Chọn ngày thôi việc hợp lệ",
      reasonRequired: "Vui lòng chọn lý do thôi việc",
      employeeMissing: "Nhân viên không tồn tại",
      staffLine: (name: string, code: string) =>
        `Nhân sự: ${name} (${code})`,
      lockLoginEffect: "Tài khoản đăng nhập sẽ bị khóa ngay lập tức.",
      cancelShiftsEffect: "Hủy các ca làm việc được phân trong tương lai.",
      closeContractEffect: "Chấm dứt hợp đồng lao động đang hoạt động.",
      keepHistoryEffect:
        "Lịch sử chấm công và bảng lương cũ được bảo toàn.",
      notePlaceholder: "Ghi chú thêm về lý do hoặc bàn giao tài sản...",
      reasons: [
        {
          value: "Nhân viên xin thôi việc",
          label: "Nhân viên xin thôi việc",
        },
        {
          value: "Hết hạn hợp đồng lao động",
          label: "Hết hạn hợp đồng lao động",
        },
        {
          value: "Thỏa thuận chấm dứt hợp đồng",
          label: "Thỏa thuận chấm dứt hợp đồng",
        },
        {
          value: "Kỷ luật / Cho thôi việc",
          label: "Kỷ luật / Cho thôi việc",
        },
        { value: "Khác", label: "Lý do khác" },
      ],
    },
    employeeDetail: {
      fallbackTitle: "Hồ sơ nhân viên",
      notRecorded: "Chưa ghi nhận",
      noPhone: "Chưa có",
      editProfile: "Sửa hồ sơ",
      changeTodayShift: "Đổi ca hôm nay",
      offboard: "Cho thôi việc",
      tabProfile: "Hồ sơ & Vị trí",
      tabTasks: (count: number) =>
        `Ca làm & Việc (${formatCount(count)})`,
      tabCompensation: "Lương & HĐLĐ",
      tabAccount: "Tài khoản & Quyền",
      jobInfo: "Thông tin công việc",
      position: "Chức vụ:",
      workplace: "Nơi làm việc:",
      employeeCode: "Mã nhân viên:",
      startDate: "Ngày bắt đầu:",
      contactPay: "Liên hệ & Thanh toán",
      phone: "Số điện thoại:",
      idNumber: "CMND / CCCD:",
      bankAccount: "Số tài khoản ngân hàng:",
      todayShift: "Ca làm hôm nay",
      changeShift: "Đổi ca",
      noShiftToday: "Chưa phân ca hôm nay",
      shiftPunchHint: "Nhân viên có thể chấm công vào khung giờ này",
      assignShiftHint:
        "Gán ca để nhân viên có thể chấm công vào hệ thống",
      shiftTasksTitle: (count: number) =>
        `Việc trong ca (${formatCount(count)})`,
      editEmployeeTemplate: "Sửa mẫu riêng",
      restorePositionTemplate: "Dùng lại chức vụ",
      required: "Bắt buộc",
      phaseDuring: "Trong ca",
      noTaskTemplate: "Chưa có danh sách việc mẫu cho chức vụ này.",
      compensationTitle: "Chế độ lương & Đãi ngộ",
      wageUnit: "Đơn vị tính lương:",
      dailyWage: "Lương ngày (theo công)",
      monthlyWage: "Lương tháng",
      payBasis: "Chế độ lương:",
      fixedMonthly: "Lương tháng cố định",
      attendanceProrated: "Theo ngày công thực tế",
      dailyRate: "Mức lương ngày:",
      baseSalary: "Lương cơ bản:",
      insuranceBase: "Lương đóng BHXH:",
      noInsurance: "Chưa tham gia BHXH",
      dependents: "Người phụ thuộc:",
      dependentsValue: (count: number) =>
        `${formatCount(count)} người (giảm trừ thuế TNCN)`,
      contractTitle: "Hợp đồng lao động",
      ...
      loginStatusHint: "Quyền truy cập ứng dụng POS, KDS và chấm công.",
      lockLogin: "Khóa đăng nhập",
      unlockLogin: "Mở khóa đăng nhập",
      statusLabel: "Trạng thái:",
      loginAllowed: "Đang cho phép đăng nhập",
      loginLocked: "Đang bị khóa",
      passwordTitle: "Mật khẩu đăng nhập",
      passwordHint: "Đặt lại mật khẩu cho nhân viên nếu quên.",
      resetPassword: "Đặt lại mật khẩu",
      newPasswordPlaceholder: "Mật khẩu mới (ít nhất 8 ký tự)",
      savePassword: "Lưu mật khẩu",
      passwordEncryptedHint:
        "Mật khẩu được mã hóa an toàn và chỉ có thể đặt lại mới.",
      permissionsTitle: "Phân quyền hệ thống",
      permissionsHint:
        "Xem chi tiết ma trận quyền và điều chỉnh ngoại lệ.",
      openPermissions: "Mở bảng phân quyền",
      deleteDraftTitle: "Xóa hồ sơ nháp",
      deleteDraftHint:
        "Chỉ dùng cho trường hợp tạo nhầm hồ sơ và chưa phát sinh chấm công hay bảng lương.",
      deleteConfirm: "Bạn có chắc chắn muốn xóa dứt điểm nhân viên này?",
      confirmDelete: "Xác nhận xóa",
      deleteThisProfile: "Xóa hồ sơ này",
      passwordTooShort: "Mật khẩu mới phải có ít nhất 8 ký tự.",
      resetFailed: "Không thể đặt lại mật khẩu.",
      resetSuccess: "Đã đặt lại mật khẩu mới cho nhân viên.",
      loginUpdateFailed: "Không thể cập nhật trạng thái đăng nhập.",
      loginEnabled: "Đã kích hoạt quyền đăng nhập hệ thống.",
      loginDisabled: "Đã tạm khóa quyền đăng nhập hệ thống.",
      deleteFailed: "Không thể xóa hồ sơ.",
      deleteSuccess: "Đã xóa hồ sơ nhân viên thành công.",
    },
    deleteDraft: {
