...
export const operator = {
  ...
  teamBoard: {
    ...
    memberDetail: {
      ...
      description: "Ca hôm nay và tóm tắt công tháng này.",
      contactSection: "Liên hệ",
      todaySection: "Hôm nay",
      monthSection: "Tháng này",
      phone: "SĐT",
      status: "Trạng thái",
      shift: "Ca",
      times: "Giờ",
      ...
      workdays: "Ngày công",
      workHours: "Giờ công",
      approvedLeaveDays: "Ngày nghỉ duyệt",
      pendingLeave: "Đơn chờ duyệt",
      monthLoading: "Đang tải công tháng này…",
      monthLoadFailed: "Không tải được công tháng này.",
      monthDetailHint: "Chi tiết từng ngày nằm ở bảng chấm công.",
      noEmployeeRecord:
        "Chưa gắn hồ sơ nhân viên — chỉ xem được thông tin liên hệ.",
      openAttendance: "Xem bảng chấm công",
