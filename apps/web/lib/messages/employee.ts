...
export const employee = {
  ...
  pwa: {
    regionLabel: "Cài đặt và trạng thái kết nối Trang cá nhân",
    offline: "Mất kết nối - Trang cá nhân cần mạng để cập nhật.",
    installHint: "Cài Trang cá nhân để mở nhanh như ứng dụng.",
    installHintShort: "Cài Trang cá nhân",
    iosInstallHint:
      "iPhone/iPad: dùng Chia sẻ để thêm Trang cá nhân vào Màn hình chính.",
    iosInstallHintShort: "iOS: thêm vào Màn hình",
    installButton: "Cài ứng dụng",
    installButtonShort: "Cài",
    installPending: "Đang mở...",
    installButtonAria: "Cài Trang cá nhân lên thiết bị",
    dismissLabel: "Tạm ẩn lời nhắc cài đặt",
    updateHint: "Có phiên bản mới của ứng dụng.",
    updateButton: "Tải lại",
    iosDialogTitle: "Cài Trang cá nhân trên iPhone/iPad",
    iosDialogDescription: "iOS cần thêm ứng dụng từ menu Chia sẻ của Safari.",
    iosSteps: [
      "Mở Trang cá nhân bằng Safari.",
      "Bấm nút Chia sẻ của trình duyệt.",
      "Chọn Thêm vào Màn hình chính, rồi bấm Thêm.",
    ],
    browserDialogTitle: "Cài Trang cá nhân trên thiết bị này",
    ...
    browserSteps: [
      ...
      "Mở biểu tượng Trang cá nhân khi bắt đầu ca.",
    ],
    close: "Đóng",
  },
  home: {
    ...
    notificationsDescription: "Kết quả nghỉ phép, kết ca và việc cần xem",
    personalHubTitle: "Trang cá nhân",
    personalHubDescription:
      "Hồ sơ, lịch làm, phép, phiếu lương và thông báo của bạn. Chấm công hàng ngày ở Hôm nay.",
  ...
  clock: {
    ...
    splitBreakTitle: "Nghỉ giữa ca",
    splitBreakDescription: "Đã tạm ra ca 1. Chụp ảnh để chấm công vào khung 2 khi đến giờ.",
    splitBreakBadge: "Nghỉ giữa ca",
    window1OutLabel: "Tạm ra khung 1",
    window2StartLabel: "Giờ khung 2",
    splitPauseButton: "Tạm ra giữa ca",
    splitPauseSubmitting: "Đang tạm ra...",
    splitPauseConfirmTitle: "Tạm ra giữa ca?",
    splitPauseConfirmDescription:
      "Thao tác này ghi nhận tạm ra kết thúc khung 1. Bạn sẽ chấm công vào lại khi đến giờ khung 2.",
    splitPauseConfirmButton: "Tạm ra",
    splitPauseFailed: "Không thể tạm ra giữa ca.",
    splitResumeButton: "Chấm vào khung 2",
    splitResumeSubmitting: "Đang chấm vào...",
    splitResumeFailed: "Chấm vào khung 2 thất bại.",
  ...
  profile: {
    ...
    bankAccountPlaceholder: "Ví dụ: 1903...",
    bankNamePlaceholder: "Ví dụ: Techcombank, MB Bank, Vietcombank...",
  ...
  leave: {
    ...
    emptyDescription: "Bấm ngày trên Lịch để xin nghỉ.",
    unavailableTitle: "Chưa thể xin nghỉ",
    missingBranchDescription:
      "Tài khoản chưa được gắn chi nhánh. Liên hệ quản lý để cập nhật hồ sơ.",
    dialogTitle: "Xin nghỉ",
    startDate: "Ngày bắt đầu",
    endDate: "Ngày kết thúc",
    leaveType: "Loại nghỉ",
    reason: "Lý do",
    reasonPlaceholder: "Không bắt buộc",
    submit: "Gửi yêu cầu",
    submitFailed: "Không thể gửi yêu cầu nghỉ.",
    ...
    backToSchedule: "Lịch",
    myRequestsLink: "Yêu cầu của tôi",
  },
  payslip: {
    title: "Lương đã trả",
