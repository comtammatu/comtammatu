export const employee = {
  ...
  home: {
    ...
    managerToolsTitle: "Quản lý chi nhánh",
  ...
  tasks: {
    ...
    notStartedBadge: "Chưa vào ca",
    doneBadge: "Đã xong",
    remainingSuffix: "chưa làm",
    checklistTitle: "Checklist",
    checklistDoneDescription: "Tất cả việc trong ca đã xong.",
    checklistWorkingDescription: "Tích xong từng việc để mở kết ca.",
    noChecklistProgress: "Không có checklist bắt buộc.",
