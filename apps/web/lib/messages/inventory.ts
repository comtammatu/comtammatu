...
export const inventory = {
  ...
  ingredients: {
    ...
    dialog: {
      ...
      defaultFulfillSiteKindLabel: "Nguồn đáp ứng mặc định",
  ...
  supplierInvoices: {
    ...
    grossLineTotalLabel: "Thành tiền",
    grossLineTotalAria: (description: string) => `Thành tiền ${description}`,
