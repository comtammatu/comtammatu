...
export const inventory = {
  ...
  shiftCockpit: {
    ariaRegion: "Nhịp đập ca kho",
    deficitAlerts: "Cảnh báo thiếu hụt",
    deficitAlertsHint: "2 quán dưới ngưỡng an toàn",
    centralKitchenBatch: "Mẻ Bếp Trung Tâm",
    centralKitchenBatchHint: "Món hoàn tất trong ca sáng",
    transfersAndLogistics: "Điều chuyển và giao nhận",
    ...
    sources: {
      ...
      localVendor: "Nhà cung cấp tại chỗ",
    },
    statuses: {
      completed: "Hoàn tất",
      inProgress: "Đang nấu",
      ...
      inTransit: "Đang giao",
      loading: "Đang bốc dỡ",
      pendingApproval: "Chờ xuất kho",
    },
    actionLabels: {
      transfer: "Điều chuyển",
      addToBatch: "Thêm vào mẻ",
      transferWarehouse: "Chuyển kho",
      directReceive: "Nhập trực tiếp",
    },
    sampleItems: {
      chaTrung: "Chả trứng hấp Má Tư",
      xiuMai: "Xíu mại sốt cà chua",
      gaoSt25: "Gạo ST25 (Bao 50kg)",
      daBi: "Đá bi sạch 20kg",
      catHalfDone: "Bán thành phẩm",
      catStaple: "Lương thực",
      catBeverageIce: "Đồ uống và đá",
      unitPortion: "phần",
      unitKg: "kg",
      unitBag: "bao",
      batchChaTrung: "Chả trứng hấp khuôn chữ nhật",
      batchXiuMai: "Xíu mại sốt cà viên lớn",
      batchSuon: "Sườn cốt lết ướp gia vị Má Tư",
      unitPan: "khuôn",
      destQ1: "Chi nhánh Quận 1",
      destLVS: "Chi nhánh Lê Văn Sỹ",
      destTB: "Chi nhánh Tân Bình",
      driverMinh: "Tài xế Minh (Xe 01)",
      driverHung: "Tài xế Hùng (Xe 02)",
    },
  },
  productionDetail: {
    kpiLines: "Dòng NL",
