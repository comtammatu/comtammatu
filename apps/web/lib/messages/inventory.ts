export const inventory = {
  ...
  dashboard: {
    ...
    oversightTagline: "Giám sát tồn, cảnh báo và luồng đang chạy.",
    oversightAllClearHint: "Không có cảnh báo hoặc luồng đang chờ theo dõi.",
    ...
    lowStockExpiryStatus: (lowStock: number, expiry: number) =>
      `${lowStock} tồn thấp / ${expiry} hạn dùng`,
    ...
    expiryLowStockStatus: (expiry: number, lowStock: number) =>
      `${expiry} hạn dùng / ${lowStock} tồn thấp`,
    ...
    runningSlipsMetricLabel: "phiếu đang chạy",
    ...
    stocktakeExpiryStatus: (stocktakes: number, expiry: number) =>
      `${stocktakes} kiểm kê / ${expiry} hạn dùng`,
    ...
    inboundNeedReceiveStatus: (count: number) => `${count} phiếu cần nhận`,
    catalogDescription:
  ...
  ingredients: {
    ...
    dialog: {
      ...
      shelfLifeLabel: "Hạn sử dụng (ngày)",
      shelfLifePlaceholder: "VD: 7",
  ...
  supplierReturns: {
    ...
    create: {
      ...
      sourceGrn: "Từ phiếu nhập",
      sourceStock: "Từ tồn kho",
      ...
      supplierPlaceholder: "Chọn nhà cung cấp",
      supplierSearch: "Tìm nhà cung cấp",
      supplierEmpty: "Không tìm thấy nhà cung cấp.",
      resolutionLabel: "Cách xử lý",
      reasonLabel: "Lý do",
      notesLabel: "Ghi chú (tùy chọn)",
      notesPlaceholder: "Ghi chú thêm cho phiếu trả...",
      addItemsTitle: "Mặt hàng trả",
      searchIngredient: "Tìm nguyên liệu để thêm",
      ingredientEmptyTitle: "Không thấy nguyên liệu",
      ingredientEmptyDescription: "Thử từ khóa khác.",
      addedSummary: (count: number) => `Đã thêm ${count} mặt hàng`,
      lineQuantityTitle: (unit: string) => `Số lượng (${unit})`,
      lineCostTitle: "Đơn giá",
      lineDetail: (qty: number, unit: string, cost: string) =>
        `${qty} ${unit} · ${cost}`,
      lineReasonPlaceholder: "Ghi chú dòng (tùy chọn)",
      removeLineAria: "Xóa dòng",
      editLineAria: "Sửa dòng",
      submitFromGrn: "Tạo phiếu trả từ phiếu nhập",
      submitFromStock: (count: number) => `Tạo phiếu trả · ${count} mặt hàng`,
      submitDisabledGrn: "Chọn phiếu nhập để tiếp tục",
      submitDisabledStock: "Thêm mặt hàng để tiếp tục",
    ...
    detail: {
      ...
      noAction: "Không có thao tác khả dụng cho trạng thái này.",
    },
  },
  reports: {
    pageTitle: "Báo cáo",
