export const inventory = {
  ...
  operatorFlow: {
    ...
    stockDescription: "Chọn việc cần làm trước, rồi mở đúng chứng từ để chốt.",
    stockSteps: [
  ...
  dashboard: {
    ...
    degradedItems: {
      ...
      priceReview: "GRN cần kiểm tra giá",
    ...
    catalogMetricValue: "4",
    catalogMetricLabel: "mục chính",
    catalogStatusLabel: "Nguyên liệu / ĐVT / NCC / Công thức",
    ...
    kpiMovementHint: "Điều phối/Sản xuất",
  ...
  supplierInvoices: {
    ...
    searchPlaceholder: "Tìm số hóa đơn, NCC, PO hoặc mã phiếu nhập",
    allSuppliers: "Tất cả nhà cung cấp",
