...
export const inventory = {
  ...
  home: {
    ...
    laneDescriptions: {
      ...
      menuRecipes: "Định mức tiêu hao nguyên liệu theo từng món bán",
    },
  },
  shiftCockpit: {
    unavailable: "Chưa tải được",
    retry: "Tải lại",
    stockTitle: "Bổ sung hàng",
    stockUnavailable: "Chưa có tổng hợp nhu cầu bổ sung hàng.",
    stockAction: "Xem tồn kho",
    productionTitle: "Sản xuất trong ngày",
    productionUnavailable: "Chưa có tổng hợp sản xuất theo ngày.",
    productionAction: "Xem lệnh sản xuất",
  },
  productionDetail: {
    kpiLines: "Dòng NL",
    kpiPlanned: "Kế hoạch",
  ...
  productionRuns: {
    metrics: {
      total: "Tổng lệnh sản xuất",
      inProgress: "Đang sản xuất",
      completed: "Đã hoàn thành",
      draft: "Dự thảo",
      runsUnit: "lệnh",
      inProgressHint: "đang chế biến",
      completedHint: "đã nhập thành phẩm",
      draftHint: "chưa bắt đầu",
    },
  },
  operatorFlow: {
  ...
  stockRequests: {
    ...
    editor: {
      ...
      autoFillSuggested: "Gợi ý tự động",
      noSuggestedItems:
        "Tồn kho hiện tại đều đạt ngưỡng, không có nguyên liệu cần bù.",
      autoFillSuccess: (count: number) =>
        `Đã thêm ${formatCount(count)} nguyên liệu chạm ngưỡng tồn`,
    },
    journey: {
      hubTitle: "Giao nhận",
      metrics: {
        total: "Tổng điều chuyển",
        active: "Đang vận chuyển",
        completed: "Hoàn tất nhận",
        cancelled: "Đã hủy",
        transfersUnit: "hành trình",
        activeHint: "đang xử lý",
        completedHint: "đã nhập kho",
      },
  ...
  grn: {
    metrics: {
      total: "Tổng phiếu nhập",
      draft: "Chờ nhập hàng",
      confirmed: "Đã nhập kho",
      unpriced: "Chờ chốt đơn giá",
      cancelled: "Đã hủy",
      grnUnit: "phiếu",
      draftHint: "chờ kiểm nhận",
      confirmedHint: "đã ghi kho",
      unpricedHint: "cần bổ sung giá",
    },
    ...
    lineHeaderLineTotal: "Thành tiền",
    lineHeaderResult: "Kết quả",
    ...
    supplierInvoiceRecorded: "Đã ghi nhận",
    supplierInvoiceNotRecorded: "Chưa ghi nhận",
    totalValueLabel: "Tổng giá trị",
    fillAllAsOrderedLabel: "Điền nhanh số lượng:",
    fillAllAsOrderedAction: "Nhận đủ theo đơn đặt hàng",
    draftQcHint:
  ...
  po: {
    ...
    metrics: {
      ...
      completed: "Đã nhập hoàn tất",
      cancelled: "Đã hủy",
      ordersUnit: "đơn",
      openHint: "cần theo dõi",
      partiallyReceivedHint: "đang giao",
      completedHint: "hoàn thành",
    },
  ...
  stock: {
    ...
    metrics: {
      ...
      inStock: "Đủ tồn kho",
      inStockHint: "an toàn",
      lowStock: "Dưới ngưỡng an toàn",
      lowStockHint: "cần bổ sung",
      outOfStock: "Hết hàng",
      outOfStockHint: "cần nhập gấp",
    },
    empty: {
  ...
  transfer: {
    ...
    creating: "Đang tạo…",
    createSlip: "Tạo phiếu",
    bulkPickerTitle: "Chọn nhiều nguyên liệu",
    bulkPickerDescription: "Tích chọn các nguyên liệu cần yêu cầu điều chuyển",
    bulkPickerTrigger: "Chọn nhiều nguyên liệu",
    bulkItemsCount: (count: number) => `${formatCount(count)} mặt hàng`,
    bulkSelectedCount: (count: number) => `Đã chọn ${formatCount(count)} mặt hàng`,
    bulkNoneSelected: "Chưa chọn mặt hàng nào",
    bulkSearchPlaceholder: "Tìm nguyên liệu...",
    bulkSearchAria: "Tìm kiếm nguyên liệu",
    bulkClearSearchAria: "Xóa tìm kiếm",
    bulkNotFoundTitle: "Không tìm thấy nguyên liệu",
    bulkNotFoundDescription: "Thử tìm kiếm với từ khóa khác",
    bulkAlreadyAddedBadge: "Đã thêm",
    bulkAddAction: "Thêm vào phiếu",
    bulkSelectIngredientAria: (name: string) => `Chọn ${name}`,
    bulkUnitLabel: (unit: string) => `ĐVT: ${unit}`,
    approxPrefix: "Khoảng",
    ...
    totalSentQtyLabel: "Tổng SL gửi:",
    totalReceivedQtyLabel: "Tổng SL nhận:",
    scopeIntraSite: "Nội bộ điểm",
    scopeInterSite: "Liên chi nhánh",
    creatorLabel: "Người lập",
    requestNumberLabel: "Theo yêu cầu",
    reconciliationLabel: "Đối soát",
    reconciliationMatch: "Khớp đủ",
    reconciliationShort: (count: number) => `Thiếu ${count} món`,
    statusPendingReceive: "Chờ nhận",
    statusMatched: "Đủ",
    statusShort: (qty: string) => `Thiếu ${qty}`,
    statusOver: (qty: string) => `Dư ${qty}`,
    discrepancyDiffShort: (qty: string) => `(Thiếu ${qty})`,
    discrepancyDiffOver: (qty: string) => `(Dư ${qty})`,
    wacCost: "Giá vốn",
    ...
    receiveNative: {
      ...
      receiveLocationTitle: "Nhận vào",
      receiveLocationWarehouse: "Kho",
      receiveLocationKitchen: "Bếp",
      receiveLocationRequired: "Chọn vị trí nhận trước khi xác nhận.",
  ...
  stocktake: {
    ...
    metrics: {
      ...
      completed: "Đã chốt đối soát",
      cancelled: "Đã hủy",
      sessionsUnit: "phiên",
      inProgressHint: "đang đếm",
      completedHint: "đã khóa sổ",
    },
  ...
  waste: {
    ...
    approvals: {
      ...
      reject: "Từ chối",
      approve: "Duyệt",
      summaryTitle: "Tổng quan duyệt hao hụt",
      totalEstimatedValue: "Tổng giá trị chờ duyệt",
      authorityBreakdown: "Phân loại thẩm quyền",
  ...
  thermalReceipt: {
    printButton: "In phiếu (80mm)",
    printNow: "In ngay",
    close: "Đóng",
    brandTitle: "Cơm Tấm Má Tư",
    ...
    grnTotalAmountLabel: "Tổng tiền hàng:",
    grnDelivererSign: "Người giao hàng",
    grnReceiverSign: "Thủ kho nhận",
    ...
    transferTime: "Thời gian:",
    transferStockRequest: "Theo yêu cầu:",
    transferColItem: "Tên hàng",
    transferColQty: "SL xuất",
    transferReceived: (qty: string, unit: string) => `Nhận: ${qty} ${unit}`,
    transferTotalLines: (count: number) => `${count} dòng`,
    transferTotalItemsLabel: "Tổng số mặt hàng:",
    transferTotalValueLabel: "Tổng giá trị:",
    transferNote: (note: string) => `Ghi chú: ${note}`,
    transferSenderSign: "Kho xuất",
    transferCarrierSign: "Vận chuyển",
    transferReceiverSign: "Kho nhận",
  },
  stocktakePrint: {
    printButton: "In phiếu kiểm kê",
    printButtonShort: "In phiếu",
    printNow: "In ngay",
    close: "Đóng",
    ...
    paperSizeThermal: "Khổ 80mm (Nhiệt)",
    modeCountSheet: "Phiếu kiểm đếm",
    modeReconciliation: "Biên bản đối soát",
    companyName: "Công ty Cổ phần Chén Sứ",
    brandTitle: "Hệ thống Cơm Tấm Má Tư",
    brandSlogan: "Thịt tươi 100%",
    formCodeCountSheet: "Mẫu số: 01-KK/MATU",
    formCodeReconciliation: "Mẫu số: 02-KK/MATU",
    countSheetTitle: "Bảng kiểm đếm tồn kho thực tế",
    countSheetSubtitle: (round: number) => `(Vòng đếm: Số ${round})`,
    reconciliationTitle: "Biên bản kiểm kê & đối soát tồn kho",
    reconciliationSubtitle: "Báo cáo đối soát tồn sổ sách và thực đếm",
    branchLabel: "Chi nhánh / Kho:",
    sessionLabel: "Mã phiên:",
    creatorLabel: "Người tạo:",
    counterLabel: "Người kiểm đếm:",
    startedTime: "Bắt đầu:",
    ...
    colNo: "STT",
    colSku: "Mã NL",
    colItem: "Tên nguyên liệu",
    colCategory: "Danh mục",
    colBaseUnit: "ĐVT chuẩn",
    colPackUnit: "Quy cách & Đơn vị tồn",
    colCountedQty: "Số thực đếm",
    countedManualHeader: (label: string) => `${label} (Ghi tay)`,
    quantityEntryLabel: "SL: .......",
    countUnitEntry: (units: string) => `ĐV: ( ${units} )`,
    colCountedUnit: "ĐV đếm",
    colConvertedQty: "Quy đổi chuẩn",
    colSystemQty: "Tồn sổ sách",
    colActualQty: "Thực đếm",
    colVariance: "Chênh lệch",
    colVariancePct: "Tỷ lệ (%)",
    colVarianceReason: "Lý do & Ghi chú",
    colNotes: "Ghi chú / HSD",
    totalItems: (count: number) => `Tổng cộng: ${count} mặt hàng`,
    matchedItems: (count: number) => `Khớp: ${count} mặt hàng`,
    varianceItems: (count: number) => `Lệch: ${count} mặt hàng`,
    varianceNegative: (count: number) => `Thiếu: ${count}`,
    variancePositive: (count: number) => `Thừa: ${count}`,
    matchedExact: "Khớp tồn",
    reasonCode: (code: string) => `Mã: ${code}`,
    missingVarianceReason: "Chưa có lý do",
    defaultCreatorName: "Thủ kho / Quản lý",
    roundValue: (round: number) => `Vòng ${round}`,
    inProgress: "Đang thực hiện",
    signCounter: "Người kiểm đếm",
    signHeadChef: "Bếp trưởng / Thủ kho",
    signManager: "Quản lý chi nhánh",
    signHint: "(Ký và ghi rõ họ tên)",
    signSimpleHint: "(Ký tên)",
    thermalWarehouseLabel: "Kho:",
    thermalRoundLabel: "Vòng:",
    thermalTimeLabel: "Thời gian:",
    thermalSystemQuantity: (quantity: string, unit: string) =>
      `Sổ: ${quantity} ${unit}`,
    thermalCountedQuantity: (quantity: string, unit: string) =>
      `Đếm: ${quantity} ${unit}`,
    thermalSummary: (matched: number, variance: number) =>
      `Khớp ${matched} · Lệch ${variance}`,
    thermalCounterSign: "Người đếm",
    thermalStorekeeperSign: "Thủ kho",
    footerSystem: "In từ hệ thống vận hành F&B Cơm Tấm Má Tư",
  },
  stockOnHandPrint: {
    printButton: "In tồn kho",
    printButtonShort: "In tồn",
    printNow: "In ngay",
    close: "Đóng",
    previewTitle: "Phiếu in tồn kho",
    ...
    paperSizeThermal: "Khổ 80mm (Nhiệt)",
    modeCountSheet: "Phiếu kiểm đếm",
    modeReconciliation: "Bảng đối chiếu tồn",
    companyName: "Công ty Cổ phần Chén Sứ",
    brandTitle: "Hệ thống Cơm Tấm Má Tư",
    brandSlogan: "Thịt tươi 100%",
    formCodeCountSheet: "Mẫu số: 03-TK/MATU",
    formCodeReconciliation: "Mẫu số: 04-TK/MATU",
    countSheetTitle: "Bảng kiểm đếm tồn kho",
    countSheetSubtitle: "Danh sách nguyên liệu kiểm tra thực tế",
    reconciliationTitle: "Báo cáo tồn kho & đối chiếu thực tế",
    reconciliationSubtitle: "Đối soát tồn kho sổ sách với thực tế",
    branchLabel: "Chi nhánh / Kho:",
    printedTime: "Ngày in:",
    creatorLabel: "Người in:",
    notesLabel: "Ghi chú:",
    colNo: "STT",
    colSku: "Mã NL",
    colItem: "Tên nguyên liệu",
    ...
    colBaseUnit: "ĐVT chuẩn",
    colPackUnit: "Quy cách & Đơn vị tồn",
    colSystemQty: "Tồn hệ thống",
    colCountedQty: "Thực tế",
    countedManualHeader: (label: string) => `${label} (Ghi tay)`,
    quantityEntryLabel: "SL: .......",
    countUnitEntry: (units: string) => `ĐV: ( ${units} )`,
    colNotes: "Ghi chú / HSD",
    totalItems: (count: number) => `Tổng cộng: ${count} mặt hàng`,
    inStockItems: (count: number) => `Còn hàng: ${count} mặt hàng`,
    lowStockItems: (count: number) => `Sắp hết: ${count} mặt hàng`,
    outOfStockItems: (count: number) => `Hết hàng: ${count} mặt hàng`,
    defaultCreatorName: "Thủ kho / Quản lý",
    signCreator: "Người lập bảng",
    signHeadChef: "Bếp trưởng / Thủ kho",
    signManager: "Quản lý chi nhánh",
    signHint: "(Ký và ghi rõ họ tên)",
    signSimpleHint: "(Ký tên)",
    thermalWarehouseLabel: "Kho:",
    thermalTimeLabel: "Thời gian:",
    thermalActualPrefix: "Thực tế:",
    thermalSystemQuantity: (quantity: string, unit: string) =>
      `Tồn: ${quantity} ${unit}`,
    thermalActualLabel: (unit: string) => `Thực tế: [.......] ${unit}`,
    thermalSummary: (inStock: number, lowStock: number, outOfStock: number) =>
      `Đủ ${inStock}${lowStock > 0 ? ` · Sắp hết ${lowStock}` : ""} · Hết ${outOfStock}`,
    thermalCreatorSign: "Người in",
    thermalStorekeeperSign: "Thủ kho",
    footerSystem: "In từ hệ thống vận hành F&B Cơm Tấm Má Tư",
  },
  documentPrint: {
    printButton: "In phiếu A4",
    close: "Đóng",
    printNow: "In ngay",
    companyName: "Công ty Cổ phần Chén Sứ",
    brandTitle: "Hệ thống Cơm Tấm Má Tư",
    ...
    branchLabel: "Chi nhánh / Kho:",
    printedAt: "In lúc:",
    documentNumberLabel: "Mã chứng từ:",
    emptyLines: "Không có dữ liệu chi tiết",
    noteLabel: "Ghi chú:",
    signatureHint: "(Ký tên)",
    fullNameHint: "(Ký và ghi rõ họ tên)",
    footerSystem: "In từ hệ thống vận hành F&B Cơm Tấm Má Tư",
    columnNumber: "STT",
    itemColumn: "Tên nguyên liệu",
    transferIssuedColumn: "SL xuất",
    transferReceivedColumn: "SL nhận",
    unitPriceColumn: "Đơn giá",
    unitCostColumn: "Giá vốn",
    amountColumn: "Thành tiền",
    transferPreviewTitle: "Phiếu điều chuyển kho",
    transferPreviewDescription: (code: string) =>
      `Xem trước và in phiếu điều chuyển ${code}.`,
    transferDocumentTitle: "Phiếu điều chuyển kho",
    transferFromBranchLabel: "Kho xuất:",
    transferToBranchLabel: "Kho nhận:",
    documentTimeLabel: "Ngày lập:",
    transferRequestLabel: "Theo yêu cầu số:",
    totalLinesLabel: "Tổng số dòng:",
    lineCount: (count: number) => `${count} dòng`,
    transferTotalValueLabel: "Tổng giá trị:",
    transferSenderSignature: "Kho xuất",
    transferCarrierSignature: "Vận chuyển",
    transferReceiverSignature: "Kho nhận",
    lineCountLabel: "Số mặt hàng:",
    statusLabel: "Trạng thái:",
    preparerSignature: "Người lập phiếu",
    grnAcceptedColumn: "Thực nhận",
    grnRejectedColumn: "Từ chối",
    grnPreviewTitle: "Phiếu nhập kho",
    grnPreviewDescription: (code: string) =>
      `Xem trước và in phiếu nhập ${code} trên khổ A4.`,
    grnDocumentTitle: "Phiếu nhập kho",
    grnSupplierLabel: "Nhà cung cấp:",
    grnPurchaseOrderLabel: "Đơn mua hàng:",
    rejectionReason: (reason: string) => `Lý do từ chối: ${reason}`,
    grnTotalAmountLabel: "Tổng tiền hàng:",
    grnDelivererSignature: "Người giao hàng",
    grnStorekeeperSignature: "Thủ kho nhận",
    issueQuantityColumn: "SL xuất",
    issueReasonColumn: "Lý do",
    issuePreviewTitle: "Phiếu xuất kho",
    issuePreviewDescription: (code: string) =>
      `Xem trước và in phiếu xuất ${code} trên khổ A4.`,
    issueDocumentTitle: "Phiếu xuất kho",
    issueTypeLabel: "Loại xuất:",
    issueTotalValueLabel: "Tổng giá trị xuất:",
    issueReceiverSignature: "Người nhận hàng",
    issueStorekeeperSignature: "Thủ kho xuất",
  },
} as const;
