  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">Lịch sử đơn hàng và trạng thái</p>
      </div>
      <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-24 text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Quản lý đơn hàng sẽ có trong Sprint 2a.</p>
      </div>
    </div>
  );
}
