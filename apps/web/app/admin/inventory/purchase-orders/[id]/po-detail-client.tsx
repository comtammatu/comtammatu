                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    {l.unit_price_est != null && (
                      <button
                        ...
                        className="size-7 flex items-center justify-center rounded text-muted-foreground hover:text-foreground"
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-right">Đơn giá dự kiến</TableHead>
