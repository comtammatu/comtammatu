  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">Hồ sơ nhân viên, ca làm, bảng lương, BHXH</p>
      </div>
      <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-24 text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Quản lý nhân sự và bảng lương sẽ có trong Sprint 6.</p>
      </div>
    </div>
  );
}
