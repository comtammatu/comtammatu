  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">Quản lý khu vực và bàn ăn theo chi nhánh</p>
      </div>
      <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-24 text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Quản lý bàn sẽ có trong Sprint 1 S5.</p>
      </div>
    </div>
  );
}
