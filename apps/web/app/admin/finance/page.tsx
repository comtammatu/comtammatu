  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">Kế toán, sổ cái và báo cáo tài chính</p>
      </div>
      <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-24 text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Quản lý tài chính sẽ có trong Sprint 6.</p>
      </div>
    </div>
  );
}
