...
export function RevenueClient({
  ...
  const periodColumns: DataTableColumn<PeriodAggregateRow>[] = [
    ...
    },
    {
      ...
      sortable: true,
      sortValue: (row) => netRevenuePreVatFor(row),
    ...
    },
    {
      ...
      sortable: true,
      sortValue: (row) => row.cash_revenue,
    ...
    },
    {
      ...
      className: "text-right font-mono tabular-nums text-muted-foreground",
      sortable: true,
      sortValue: (row) => row.vietqr_revenue,
    ...
    },
    {
      ...
      className: "text-right font-mono tabular-nums text-muted-foreground",
      sortable: true,
      sortValue: (row) => row.platform_revenue,
    ...
    },
    {
      ...
      className: "text-right font-mono tabular-nums text-muted-foreground",
      sortable: true,
      sortValue: (row) => row.delivery_revenue,
  ...
  const cashierColumns: DataTableColumn<CashierRow>[] = [
    ...
    },
    {
      ...
      className: "text-right font-mono tabular-nums",
      sortable: true,
      sortValue: (row) => Number(row.order_count),
    ...
    },
    {
      ...
      className: "text-right font-mono tabular-nums font-medium",
      sortable: true,
      sortValue: (row) => Number(row.net_revenue),
    ...
    },
    {
      ...
      className: "text-right font-mono tabular-nums text-muted-foreground",
      sortable: true,
      sortValue: (row) => Number(row.cash_revenue),
  ...
  const topItemColumns: DataTableColumn<TopItemRow>[] = [
    ...
    },
    {
      ...
      className: "text-right font-mono tabular-nums",
      sortable: true,
      sortValue: (row) => Number(row.quantity_sold),
