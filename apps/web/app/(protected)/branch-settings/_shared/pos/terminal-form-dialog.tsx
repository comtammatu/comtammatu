...
export function TerminalFormDialog({
  ...
  return (
    <FormDialog
      ...
      title={isEdit ? copy.editTerminalTitle : copy.createTerminalTitle}
      successMessage={isEdit ? copy.terminalUpdated : copy.terminalCreated}
            ...
            <Controller
              ...
              render={({ field }) => (
                <Field orientation="horizontal">
                  ...
                  />
                  <FieldLabel htmlFor="terminal-active">
                    {copy.terminalActive}
                  </FieldLabel>
                </Field>
              )}
