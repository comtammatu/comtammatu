...
export const POS_ERROR_CODES = {
  ...
  INPUT_INVALID_SERVICE_CHARGE: "INPUT_INVALID_SERVICE_CHARGE",
  ...
  SCOPE_SESSION_NOT_OPEN: "SCOPE_SESSION_NOT_OPEN",
  ...
  INGREDIENT_STOCK_INSUFFICIENT: "INGREDIENT_STOCK_INSUFFICIENT",
