...
import { ShieldCheck as IconShieldCheck, UserPlus as IconUserPlus } from "lucide-react";
...
export function HrClient({ employees, branches, positionOptions }: HrClientProps) {
