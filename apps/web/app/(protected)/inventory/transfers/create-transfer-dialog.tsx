  ...
  return (
    <form onSubmit={controller.submit} className="flex min-w-0 flex-col gap-4">
      ...
      <AppSection title={copy.createTransferTitle}>
        {controller.canCreateInboundRequest ? (
          ...
          <div className="flex flex-col gap-3">
            ...
            sourceBranch ? (
              <FormField
                controlId="transfer-source-location"
      ...
      <AppSection title={FORM_VI.notes}>
        <FormField controlId="transfer-vehicle" label={copy.vehicleInfo}>
          <Input
            id="transfer-vehicle"
            name="vehicleInfo"
            className="h-10"
        ...
        <FormField controlId="transfer-notes" label={FORM_VI.notes}>
          <Textarea
            id="transfer-notes"
            name="notes"
            rows={3}
