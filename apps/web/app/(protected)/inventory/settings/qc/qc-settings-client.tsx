      ...
      <div className="mx-auto max-w-3xl space-y-6">
        <Alert>
          <AlertDescription>
            ...
            ngưỡng này áp dụng toàn tenant. Webhook nhận thông báo khi có cảnh
            báo realtime.
          </AlertDescription>
        </Alert>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Để trống = bỏ qua. Hệ thống POST JSON vào URL này khi có sự kiện{" "}
                <code>grn.requires_review</code> hoặc{" "}
                <code>supplier_return.created</code>. Outbox tự retry tối đa 3
                lần khi HTTP fail.
              </p>
            </div>
          </CardContent>
