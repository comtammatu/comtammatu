        ...
        {visibleTabs.map((tab) => {
          ...
          return (
            <Link
              ...
              href={tab.href}
              className={cn(
                "relative -mb-2 inline-flex items-center rounded-full border px-4 py-2.5 text-sm font-semibold whitespace-nowrap transition-all duration-150 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none",
                isActive
