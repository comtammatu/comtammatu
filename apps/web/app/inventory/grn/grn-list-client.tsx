  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 md:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)]">
        ...
        <div className="app-panel border-primary/15 bg-primary/5">
          <div className="flex items-center justify-between gap-6">
            <div>
              <p className="app-kicker">Giá trị GRN tháng này</p>
      ...
      <SectionCard
        title="Danh sách GRN"
        description="Toàn bộ phiếu kiểm nhận theo nhà cung cấp, PO liên kết và trạng thái xử lý tại hub nhập hàng HQ."
      ...
      >
        <div className="mb-4 flex items-center gap-3">
          ...
          <span className="px-3 py-1 text-sm text-muted-foreground">Mới nhất</span>
          <span className="px-3 py-1 text-sm text-muted-foreground">Giá trị cao</span>
        </div>
            ...
            {grns.map((g) => (
              ...
              >
                ...
                <TableCell className="text-sm font-semibold">
                  {formatVND(g.total)} <span className="text-xs opacity-40">₫</span>
                </TableCell>
                <TableCell>
