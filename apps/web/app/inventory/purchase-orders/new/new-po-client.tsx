    ...
    <div className="max-w-4xl space-y-5">
      ...
      <div>
        <Button variant="ghost" size="sm" asChild className="-ml-2 mb-1">
          <Link href="/inventory/purchase-orders">← Danh sách PO</Link>
        </Button>
        <h1
      ...
      <div className="flex items-center justify-between pt-1">
        <Button variant="ghost" asChild>
          <Link href="/inventory/purchase-orders">Hủy</Link>
        </Button>
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="inline-flex items-center rounded-full px-6 py-2.5 text-sm font-semibold text-white shadow-md transition-shadow hover:shadow-lg disabled:opacity-40 disabled:cursor-not-allowed"
            style={{
              background:
...
function SupplierSection({
  ...
  return (
    <div
      className="rounded-2xl ambient-shadow p-5"
      style={{
  ...
  return (
    <Collapsible open={suggestionsOpen} onOpenChange={onOpenChange}>
      <div
        ...
        style={{
          backgroundColor:
            "color-mix(in srgb, var(--md-info-container) 20%, var(--md-surface-lowest))",
          border:
            "1px solid color-mix(in srgb, var(--md-on-info-container) 15%, transparent)",
        }}
      >
            ...
            <div className="flex items-center gap-2">
              ...
              {suggestions.length > 0 && (
                <span
                  ...
                  style={{
                    backgroundColor: "var(--md-info-container)",
        ...
        <CollapsibleContent>
          <div
            ...
            style={{
              borderColor:
                "color-mix(in srgb, var(--md-on-info-container) 10%, transparent)",
            }}
          >
...
function LineItemsSection({
  ...
  return (
    ...
    >
      {/* Table header */}
      <div
        className="grid grid-cols-[2fr_80px_70px_120px_120px_40px] gap-0 border-b px-4 py-3"
        style={{
          backgroundColor:
            "color-mix(in srgb, var(--md-surface-low) 50%, transparent)",
          borderColor:
        ...
        <div>
          {lines.map((l, idx) => {
            ...
            return (
              <div
                key={idx}
                className="grid grid-cols-[2fr_80px_70px_120px_120px_40px] gap-0 items-center border-b px-4 py-3 transition-colors"
                style={{
                  borderColor:
                    "color-mix(in srgb, var(--md-outline-variant) 10%, transparent)",
                }}
          ...
          {hasValue && (
            <div
              className="grid grid-cols-[2fr_80px_70px_120px_120px_40px] gap-0 items-center border-b px-4 py-2.5"
              style={{
                backgroundColor:
            ...
            >
              <span
                className="col-span-4 text-xs font-bold text-right uppercase tracking-widest"
                style={{ color: "var(--md-outline)" }}
              >
                Tổng dự kiến
              </span>
      ...
      <form
        onSubmit={handleAddLine}
        className="grid grid-cols-[2fr_80px_70px_120px_120px_40px] gap-0 items-center border-t px-4 py-2.5"
        style={{
          borderColor:
            "color-mix(in srgb, var(--md-outline-variant) 10%, transparent)",
        }}
      >
        ...
        <div className="pl-2 flex justify-end">
          <button
            type="submit"
            disabled={!ingredientId}
            className="size-7 flex items-center justify-center rounded-full text-white disabled:opacity-40 disabled:cursor-not-allowed transition-colors shadow-sm"
            style={{
