...
const po = {
  ...
  total: 57_250_000,
  tax: 4_580_000,
  grandTotal: 61_830_000,
  supplierInfo: {
    address: "124 Nguyễn Bỉnh Khiêm, P.6, Quận 3, TP. HCM",
    contact: "Anh Tuấn – 0908.xxx.123",
    payment: "T+15 (Sau khi nhận hàng)",
  },
  items: [
    {
      name: "Sườn non loại 1",
      sku: "MEAT-001",
      qty: 150,
      unit: "Kg",
      price: 185_000,
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <TimelineStepper
          steps={[
            { label: "Draft", date: "07/04, 09:30", completed: true },
            { label: "Sent", date: po.sentAt, completed: true },
