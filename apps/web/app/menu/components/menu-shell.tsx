            ...
            <div className="workspace-sidebar-card">
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xl font-semibold">Thực đơn</p>
                </div>
              </div>
              <p className="mt-4 text-sm leading-6 text-sidebar-foreground/72">
                Quản lý danh mục món, biến thể và topping theo cùng một tuyến
                nhập liệu.
              </p>
            </div>
          </SidebarHeader>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="max-w-3xl text-sm leading-7 text-muted-foreground sm:text-base">
                      Nhập danh mục, món ăn, biến thể và topping cho toàn chuỗi
                      tại cùng một nơi.
                    </p>
                  </div>
                </div>
