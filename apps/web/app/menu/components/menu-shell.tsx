...
import { ArrowLeft as IconArrowLeft, LayoutDashboard as IconLayoutDashboard, LogOut as IconLogout, Utensils as IconToolsKitchen } from "lucide-react";
        ...
        <SidebarHeader className="gap-3 p-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 space-y-0.5 group-data-[collapsible=icon]:hidden">
              ...
              <p className="text-lg font-semibold leading-none">Thực đơn</p>
            </div>
          </div>
        </SidebarHeader>
        ...
        <header className="flex flex-col gap-4 border-b p-4 xl:flex-row xl:items-start xl:justify-between">
          <div className="flex-1 space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Badge variant="outline">Catalog · Thực đơn</Badge>
            ...
            <div className="space-y-1.5">
              ...
              <p className="max-w-3xl text-sm leading-6 text-muted-foreground sm:text-base">
                Nhập danh mục, món ăn, biến thể và topping cho toàn chuỗi tại
                cùng một nơi.
              </p>
            </div>
          </div>
