...
| ---------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------- | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **UI** / UX / copy / route surface             | `ui.md`, `spec/design-system.md`, `modules/ui.md`, `tasks/regressions.md` | "UI, UX, route surface…"              | T2 (T3 if auth-gated flow) | product surfaces: `vercel:shadcn` for primitives, `frontend-design` for composition, `impeccable` only for explicit audit/polish; brand/landing only: `design-taste-frontend` |
