...
| UI/UX/route/copy                | `ui.md` and its routed SSOTs                              | At most one design reviewer; browser after UI Advisor Gate | Runtime/browser smoke for meaningful UI             |
...
| Money/legal/tax/labor           | Domain ref + `database.md`, `workflow.md`                 | Official/current sources and DB tools as needed            | T3; cite governing repo source                      |
