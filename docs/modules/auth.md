...
| Branch employee task overrides | `/br/[branchId]/team` (Nhân viên) | `hr:manage_employee_shift_overrides` (branch)                          | same save/clear employee override RPCs          | employee templates for staff on the actor branch only; not position templates |
