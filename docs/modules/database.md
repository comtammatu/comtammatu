...
| Branch network | `branch_trusted_egress_ips` — trusted egress for POS/KDS/print network gates; `branch_network_gate_bypasses` — owner per-branch emergency gate suspension (TTL / POS shift / business day); unrelated to Inventory QC |
