...
| an open order exists, a live payment intent       | `Đang thanh toán`         | browse, add-more (QR refreshes to the new total), reopen or resume the live QR              |
