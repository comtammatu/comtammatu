...
6. Database contract: `supabase/migrations/20260720035548_baseline.sql` (bảng notifications; migration gốc nằm trong `supabase/migration-archive/`) and forward notification migrations
