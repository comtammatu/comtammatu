...
| Quản lý kho Tổng (`central_supply_ops`) | /br/{branchId} (central site operator hub) | /br/{branchId} (central site operator hub) | Pinned central site roles land on the operator hub for their JWT branch_id; Owner/Accountant keep control_surface /inventory oversight. |
| Bếp trưởng Bếp TT (`central_kitchen_lead`) | /br/{branchId} (central site operator hub) | /br/{branchId} (central site operator hub) | Pinned central site roles land on the operator hub for their JWT branch_id; Owner/Accountant keep control_surface /inventory oversight. |
