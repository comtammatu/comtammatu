...
| beFood        | Chưa xác nhận luồng gửi phiếu trực tiếp tới Má Tư Agent trên Redmi; developer portal có `Food API` nhưng quyền truy cập chưa xác nhận | Chưa tích hợp; beMerchant vẫn là nguồn vận hành | beMerchant quản lý menu/hiển thị | beMerchant có `Đã chuẩn bị`; API chưa rõ | Chuyển khoản theo lịch công bố; API chưa rõ | Xem `food-delivery-matu-agent.md` |
| ShopeeFood    | Má Tư Agent nhận phiếu ESC/POS qua TCP 9100 (ADR 0046) | App nhận đơn, tự động gửi phiếu qua Agent sang POS/KDS | Đồng bộ trạng thái món, hết hôm nay qua webhook item-status | Hủy qua tổng đài/CSKH; khiếu nại bồi hoàn qua Ví Quán             | Ví Quán (Shopee Partner Wallet); rút về tài khoản CTCP Chén Sứ   | Xem `food-delivery-matu-agent.md`; không chạy song song extension |
| Green SM Food | Green SM Merchant trên Redmi vẫn yêu cầu máy in Bluetooth/SUNMI; không thấy public API/POS docs | Chưa tích hợp trực tiếp với Má Tư Agent | App tạo/sửa/xóa món, topping, ngừng bán | App có trạng thái đơn/cửa hàng; hủy API chưa rõ | Ví cửa hàng, lịch sử và rút tiền bằng OTP | Xem `food-delivery-matu-agent.md` |
