...
| ShopeeFood    | Integration POS cấp đối tác (Ocha/Sapo) & Virtual WiFi/LAN ESC/POS Printer Bridge trên SUNMI POS (ADR 0046) | App nhận đơn, tự động in bill qua TCP 9100 sang KDS/Máy in | Đồng bộ trạng thái món, hết hôm nay qua webhook item-status | Hủy qua tổng đài/CSKH; khiếu nại bồi hoàn qua Ví Quán             | Ví Quán (Shopee Partner Wallet); rút về tài khoản CTCP Chén Sứ   | Chi nhánh chạy Virtual Printer Bridge (xem `food-delivery-sunmi-pos-bridge.md`) |
