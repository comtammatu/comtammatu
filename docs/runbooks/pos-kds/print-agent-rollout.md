# Print Agent — Rollout & SOP

Runbook for deploying the thermal print agent to a branch and the offline
...
- DB schema: `supabase/migrations/20260720035548_baseline.sql` (print_jobs,
