...
- **Luồng thao tác (Workflow):**
  ...
  2. Đối chiếu chi nhánh, mã đơn và số tiền trên khối tiêu đề gọn; mở Chi tiết hóa đơn cùng hàng khi cần đối chiếu từng dòng như phiếu thanh toán (số lượng, đơn giá, thành tiền, thuế suất GTGT).
...
- **Thông tin hiển thị:**
  - **Nên hiển thị:** Chi nhánh, mã đơn, số tiền, dòng món kiểu phiếu (số lượng, đơn giá, thành tiền, thuế suất GTGT), thời hạn, MST, tên đơn vị và địa chỉ do API trả về, email nhận HĐĐT, trạng thái tra cứu và kết quả xác nhận.
