...
| `startup_capital`        | Chi phí ban đầu               | Vốn đã bỏ ra cho quán/chi nhánh: thi công, máy, xe, nội thất, đặt cọc. Không phải chi vận hành tháng. | Sum `expenses.amount` `capital`+`deposit`, không theo kỳ; gồm GTGT. Chi nhánh chỉ dòng `branch_id` khớp, không gồm `NULL`. | Chi vận hành tháng, giá vốn món, HĐ NCC, khấu hao kỳ, chi Công ty. | `finance.expense.startup_capital`.                                  |
| `capital_outlay`         | Thiết bị                      | Khoản chi mở quán ghi `expenses.category = capital` (thi công, máy, xe, nội thất). Card `/finance` Tài sản; sổ `/finance/equipment`. Không phải sổ TSCĐ hay giá trị còn lại. | Cùng nguồn `startup_capital`, chỉ nhóm `capital`. Thành phần của `Tổng giá trị`.                | Đặt cọc, chi vận hành, giá vốn món, `Giá trị thiết bị`.                                                | `finance.asset.equipment`.                                  |
