...
| `capital_outlay`         | Thiết bị                      | Khoản chi mở quán ghi `expenses.category = capital` (thi công, máy, xe, nội thất). Card `/finance` Tài sản. Không phải sổ TSCĐ hay giá trị còn lại. | Cùng nguồn `startup_capital`, chỉ nhóm `capital`.                                                | Đặt cọc, chi vận hành, giá vốn món, `Giá trị thiết bị`.                                                | `finance.asset.equipment`.                                  |
