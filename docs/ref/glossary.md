...
| `total_collected`        | Tổng tiền đã thu              | Tổng giá trị payment hoàn tất trong kỳ, có thể gồm VAT và phụ thu ngày lễ không phải doanh thu.            | Sum `payments.amount` completed tại `paid_at`, bucket theo ngày Việt Nam.                        | Doanh thu thuần, HĐĐT đã phát hành, công nợ, doanh thu tính thuế.                       | `finance.revenue.money_collected`.                                  |
...
| `operating_result`       | Kết quả vận hành              | Kết quả sau khi trừ chi phí vận hành và cộng biến động tồn kho đã ghi nhận vào doanh thu thuần.            | `net_sales_before_vat - operating_expense + inventory_movement`.                                 | Lợi nhuận gộp, lợi nhuận ròng, dòng tiền, kết quả kê khai thuế.                         | `finance.operating_result`.                                         |
...
| `service_charge`          | phụ thu ngày lễ                  | Khoản thu không phải doanh thu, cộng vào payment nhưng loại khỏi tổng HĐĐT.    | tip, VAT, doanh thu món        |
...
- `Tổng tiền đã thu` là money collected qua payment đã hoàn tất; dùng trên màn
  chi tiết doanh thu và phải nói rõ có thể gồm VAT và phụ thu ngày lễ không
  phải doanh thu.
