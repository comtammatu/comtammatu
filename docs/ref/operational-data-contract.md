...
| `expenses.vat_breakdown` | GTGT đầu vào đã ghi nhận trên chi phí vận hành | GTGT đầu vào được khấu trừ | Cùng giới hạn; `expenses.amount` vẫn là tổng gross (= subtotal + VAT). |
