...
| Kết quả vận hành        | Lợi nhuận gộp trừ chi phí vận hành đã ghi nhận.                                   | Lợi nhuận ròng hoặc kết quả kê khai thuế.                                   |
...
Finance landing có năm card kết quả theo kỳ theo đúng thứ tự:
`Doanh thu thuần − Giá vốn món = Lợi nhuận gộp − Chi phí vận hành =
...
| `finance.operating_result`                  | Kết quả vận hành        | Sau giá vốn món và chi phí vận hành, hoạt động trong kỳ còn bao nhiêu?     | `finance.gross_profit.readonly - finance.expense.operating`.                                                                           | Chỉ tính khi food-cost coverage đầy đủ và đã ghi nhận chi phí vận hành; không gọi là lợi nhuận ròng.                                                   |
...
| `Kết quả vận hành`           | `buildKpis` trong Finance cockpit.                                                                                   | `Lợi nhuận gộp - Chi phí vận hành`.                                                                                                                                                                                                                                                                                                         | Chỉ hiển thị tiền khi food-cost coverage đầy đủ và đã ghi nhận chi phí vận hành; không phải lợi nhuận ròng.                                                                                                                   | Hiển thị `Chưa tính`.                                                                          |
