...
| `Tiền mặt`, `VietQR`, `MoMo` | Cùng RPC doanh thu.                                                                                | Tổng `payments.amount` theo `payments.method`.                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Đúng theo dòng tiền thực nhận; sửa phương thức thanh toán dùng `payments.method` làm nguồn.                                                                                                 | Payment-method cards phải bị coi là cần rà soát nếu có duplicate completed payments. |
