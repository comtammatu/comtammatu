...
| `finance.expense.operating`                 | Chi phí vận hành        | Kỳ này đã ghi nhận bao nhiêu chi phí vận hành?                             | `expenses.amount` thuộc `rent`, `utilities`, `gas_fuel`, `salary`, `repair`, `supplies`, `marketing`, `fees_tax`, `other`.             | `trusted` khi có ít nhất một expense hợp lệ trong kỳ; nếu chưa có thì trạng thái là `not_recorded`.                                                    |
...
| `finance.operating_result`                  | Kết quả vận hành        | Sau giá vốn món, chi phí vận hành và biến động tồn kho, hoạt động trong kỳ còn bao nhiêu? | `finance.gross_profit.readonly - finance.expense.operating - (inventory.closing - inventory.opening)`.                                  | Chỉ tính khi food-cost coverage đầy đủ và đã ghi nhận chi phí vận hành; tồn tăng làm giảm kết quả; không gọi là lợi nhuận ròng.                       |
