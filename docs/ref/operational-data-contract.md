...
| Kết quả vận hành        | Lợi nhuận gộp trừ chi phí vận hành và biến động tồn kho đã ghi nhận.              | Lợi nhuận ròng hoặc kết quả kê khai thuế.                                   |
...
| `finance.operating_result`                  | Kết quả vận hành        | Sau giá vốn món, chi phí vận hành và biến động tồn kho, hoạt động trong kỳ còn bao nhiêu? | `finance.gross_profit.readonly - finance.expense.operating - (inventory.closing - inventory.opening)`.                                  | Chỉ tính khi food-cost coverage đầy đủ và dữ liệu chi phí vận hành khả dụng; kỳ không có chi phí dùng `0`; tồn tăng làm giảm kết quả; không gọi là lợi nhuận ròng. |
...
| `Kết quả vận hành`           | `buildKpis` trong Finance cockpit.                                                                                   | `Lợi nhuận gộp - Chi phí vận hành - (Tồn cuối kỳ - Tồn đầu kỳ)`.                                                                                                                                                                                                                                                                            | Chỉ hiển thị tiền khi `costAvailable=true`; tồn tăng làm giảm kết quả; không phải lợi nhuận ròng.                                                                                                                         | Hiển thị `Chưa tính`.                                                                          |
