...
| `Tiền mặt ở quán`        | `fetchCashSummary`.                                                                                | Số dư mở tiền mặt + tiền mặt đã thu − chi vận hành đã trả tiền mặt − thanh toán NCC tiền mặt − hoàn tiền mặt, tính từ mốc mở.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Số dư tenant-wide; không đổi theo bộ lọc kỳ hoặc chi nhánh trên `/finance`.                                                                                                             | Hiển thị `—` cho đến khi chủ quán đặt mốc tồn quỹ.                                   |
| `Tiền trong ngân hàng`   | `fetchCashSummary` -> `fetchSepayBankMovementSince`.                                               | Số dư mở ngân hàng + tổng SePay tiền vào − tổng SePay tiền ra, tính từ cùng ngày mốc mở.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Số dư tenant-wide; mỗi signed SePay movement chỉ được tính một lần và không cộng/trừ lại từ expense/AP.                                                                                  | Hiển thị `—` cho đến khi chủ quán đặt mốc ngân hàng.                                 |
