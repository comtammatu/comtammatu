# HĐĐT Hybrid via MISA meInvoice — Historical Plan
...
> **Superseded 2026-05-23:** Runtime provider is Viettel S-invoice only. MISA references in this file are historical planning context, not active implementation guidance.
