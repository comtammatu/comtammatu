...
> **ARCHIVED 2026-05-24** — early-2026 schema snapshot. Current schema
> orientation lives in `docs/spec/database-schema.md`; current usable shape
> lives in `packages/database/src/types/database.types.ts`.
