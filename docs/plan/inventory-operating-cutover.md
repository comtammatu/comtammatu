...
| **4 Freeze writes** | REVOKE YCM/YCH writes (`20260820123758`); hygiene + strip request ACL + expire notifs + REVOKE allocate (`20260820170001`). Redirects already in app (YCM→PO, YCH→DC). | Wave 1 **and** Wave 3 live; hygiene close leftover vouchers | — |
