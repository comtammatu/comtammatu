...
- POS/KDS stations get a persistent return-to-Hub link in the PWA toolbar (Runner excluded — guest display); in installed/standalone quiet mode the toolbar keeps a slim row so the link stays reachable.
