...
- [2026-04-02] VERIFY-BEFORE-DONE — Never mark a task completed until `pnpm typecheck && pnpm build` output is confirmed green. Generated types may have `| null` where manual stubs assumed non-null.
