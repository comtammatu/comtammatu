...
> **Test plan ref:** [tasks/inventory-qa-e2e-2026-05-06.md](inventory-qa-e2e-2026-05-06.md)
...
- `tasks/inventory-qa-e2e-2026-05-06.md` — unified test plan
- `docs/ref/inventory-rbac-matrix.md` — RBAC matrix source of truth
- `docs/ref/inventory-sop.md` — SOP
- `docs/plan/inventory-v2-rebuild.md` — green project rebuild plan
