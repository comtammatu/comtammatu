...
## Delay per-order HĐĐT issuance for receipt-QR buyer details
...
- [ ] Complete authenticated HTTP smoke for the receipt-QR route against a disposable Preview schema.
