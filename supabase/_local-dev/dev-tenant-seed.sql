...
CROSS JOIN (VALUES
  ...
  ('kho_truong', 'warehouse_manager', ARRAY['hr:request_leave','inventory:read','inventory:stocktake_complete','inventory:stocktake_create','inventory:stocktake_recount','inventory:transfer_create','inventory:transfer_receive','inventory:transfer_ship','inventory:write','inventory:writeoff','procurement:grn_confirm','procurement:grn_create','procurement:po_create','procurement:read','procurement:supplier_manage','supplier_return:confirm','supplier_return:create','supplier_return:read']),
  ('bep_truong', 'head_chef', ARRAY['hr:request_leave','inventory:production_confirm','inventory:production_create','inventory:read','inventory:transfer_create','inventory:transfer_receive','inventory:transfer_ship','kds:mark_ready','kds:recall','kds:use','menu:read','menu:write','procurement:read']),
  ('quan_ly_CN', 'branch_manager', ARRAY['dashboard:view','hr:approve_leave_request','hr:approve_checkout','hr:request_leave','inventory:adjust_approve','inventory:grn_express_extend','inventory:item_review_override_set','inventory:read','inventory:stocktake_complete','inventory:stocktake_create','inventory:stocktake_recount','inventory:transfer_create','inventory:transfer_receive','inventory:waste_approve','inventory:write','kds:mark_ready','kds:recall','kds:use','menu:read','orders:read','orders:refund','orders:void','orders:write','pos:apply_discount','pos:close_shift','pos:close_shift_variance_override','pos:confirm_payment','pos:open_cashbox','pos:print','pos:reprint_receipt','pos:send_kitchen','pos:use','pos:void_order','printer:manage','procurement:override_code_rotate','procurement:price_list_read','reports:export','reports:view_branch','settings:branch','staff:manage','staff:view','supplier_return:confirm','supplier_return:create','supplier_return:read','hr:view_employee']),
  ('office', 'office', ARRAY['dashboard:view','hr:approve_leave_request','hr:manage_employee','hr:request_leave','hr:view_employee','staff:manage','staff:view']),
  ('owner', 'owner', ARRAY['accounting:period_reopen','crm:campaign_send','crm:read','crm:write','dashboard:view','finance:ap_pay','finance:expense_approve','finance:expense_create','finance:payroll_approve','finance:payroll_calculate','finance:view','hr:approve_leave_request','hr:approve_checkout','hr:manage_employee','hr:request_leave','hr:view_employee','inventory:adjust_approve','inventory:catalog_review_policy_set','inventory:grn_express_configure','inventory:grn_express_extend','inventory:grn_hardblock_override','inventory:item_review_override_set','inventory:production_confirm','inventory:production_create','inventory:read','inventory:stocktake_complete','inventory:stocktake_create','inventory:stocktake_recount','inventory:stocktake_unblind','inventory:transfer_create','inventory:transfer_receive','inventory:transfer_ship','inventory:waste_approve','inventory:waste_bypass_photo','inventory:write','inventory:writeoff','kds:mark_ready','kds:recall','kds:use','menu:manage_category','menu:publish','menu:read','menu:write','orders:read','orders:refund','orders:refund_approve','orders:void','orders:write','pos:apply_discount','pos:close_shift','pos:close_shift_variance_override','pos:confirm_payment','pos:open_cashbox','pos:print','pos:reprint_receipt','pos:send_kitchen','pos:use','pos:void_order','printer:manage','procurement:grn_amend','procurement:grn_confirm','procurement:grn_create','procurement:invoice_create','procurement:invoice_match','procurement:override_code_rotate','procurement:po_approve','procurement:po_create','procurement:price_list_read','procurement:price_list_write','procurement:read','procurement:supplier_manage','reports:export','reports:pit_export','reports:view_branch','reports:view_tenant','settings:branch','settings:integrations','settings:tenant','staff:assign_permission','staff:assign_position','staff:manage','staff:view'])
