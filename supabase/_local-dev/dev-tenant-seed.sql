...
CROSS JOIN (VALUES
  ...
  ('warehouse_manager', 'warehouse_manager', ARRAY['hr:request_leave','inventory:count_approve','inventory:count_assign','inventory:read','inventory:stocktake_complete','inventory:stocktake_create','inventory:stocktake_recount','inventory:transfer_create','inventory:transfer_receive','inventory:transfer_ship','inventory:units_master','inventory:write','inventory:writeoff','procurement:grn_confirm','procurement:grn_create','procurement:po_create','procurement:read','procurement:supplier_manage','supplier_return:confirm','supplier_return:create','supplier_return:read']),
  ('head_chef', 'head_chef', ARRAY['hr:request_leave','inventory:production_confirm','inventory:production_create','inventory:read','inventory:stocktake_complete','inventory:stocktake_create','inventory:stocktake_recount','inventory:transfer_create','inventory:transfer_receive','inventory:transfer_ship','inventory:writeoff','kds:mark_ready','kds:recall','kds:use','menu:read','menu:write','procurement:grn_confirm','procurement:grn_create','procurement:read']),
  ('production_manager', 'production_manager', ARRAY['hr:request_leave','inventory:production_confirm','inventory:production_create','inventory:read','inventory:stocktake_complete','inventory:stocktake_create','inventory:stocktake_recount','inventory:transfer_create','inventory:transfer_receive','inventory:transfer_ship','inventory:writeoff','kds:mark_ready','kds:recall','kds:use','menu:read','menu:write','procurement:grn_confirm','procurement:grn_create','procurement:read']),
