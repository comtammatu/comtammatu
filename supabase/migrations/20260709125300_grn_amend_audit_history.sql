...
COMMENT ON FUNCTION public.amend_grn_line(
  ...
  text,
  numeric
) IS 'Owner-only post-confirm GRN line amendment. Delta posts to the GRN receipt location, is converted from entry unit to ingredient base before posting stock_movements, and writes audit history on the GRN header.';
