    ...
    WHEN 'kitchen_ticket' THEN
      RETURN jsonb_build_object(
        'blocks', jsonb_build_array(
          ...
          jsonb_build_object('type', 'text', 'text', 'Người nhận đơn: {{cashier_name}}', 'when_field', 'cashier_name', 'when_not_empty', true),
...
REVOKE ALL ON FUNCTION public.print_template_default_content(text)
  FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.print_template_default_content(text)
  TO service_role;
