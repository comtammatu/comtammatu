-- Migration: fix_self_service_clock_in_checklist
-- Fixes self_service_clock_in checklist population to use public.position_shift_tasks
-- while preserving split shift scheduled_start_at_2 and scheduled_end_at_2 tracking.
...
DECLARE
  ...
  v_scheduled_start_2 timestamptz;
  v_scheduled_end_2 timestamptz;
