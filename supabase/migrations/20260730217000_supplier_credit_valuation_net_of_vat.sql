-- Supplier credit amounts reduce gross AP; only the net inventory share reprices stock.
    ...
    LOOP
      ...
      VALUES (
        ...
        pg_catalog.jsonb_build_object(
          ...
          'gross_credit_amount', NEW.amount,
          'net_inventory_credit', v_net_inventory_credit
        ),
        v_credit.created_by
      )
