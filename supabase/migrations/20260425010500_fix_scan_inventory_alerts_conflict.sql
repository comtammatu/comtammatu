-- =============================================================
-- Fix: partial unique index `ux_notifications_dedup` requires the
-- predicate on the ON CONFLICT clause for Postgres to match it.
-- Adding `WHERE dedup_key IS NOT NULL` to both upsert sites.
-- =============================================================
