-- Branch business-day Daily Summary totals for /close-day (ADR 0024).
-- Gate: settings:branch OR finance:view. Aggregates only — no unit WAC.

CREATE FUNCTION public.get_branch_day_report(
  p_branch_id bigint,
