-- Restore route_order_to_kds to the pre-fail-loud body: items whose category
-- has no station and no kitchen-ticket printer are silently skipped again (no
-- RAISE). Use only to revert 20260621100000_route_order_to_kds_fail_loud.sql.
