-- Restore Inventory Pilot Contract V2 default-consumption gates.
--
-- Emergency hotfix migrations 20260427125425/20260427125706 made
-- inventory_locations.is_default_consumption optional at runtime. That makes
-- POS consumption and branch "Cap bep" pick any active kitchen location, which
-- breaks the Pilot V2 contract: Branch Kitchen/default_consumption is a setup
-- gate, not a best-effort hint.
--
-- Re-create the affected RPCs from 20260427103652_inventory_pilot_contract_v2
-- instead of patching function text in-place, so the SQL body is explicit and
-- reviewable.
