...
COMMENT ON FUNCTION public.upsert_recipe_lines(bigint, jsonb, bigint) IS 'Atomically replace the recipe lines of a menu item. Inserts or updates provided lines, clears old menu item recipe if changed, and deletes removed lines.';
