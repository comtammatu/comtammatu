-- Add target_branch_id and ingredients_override to production_runs
ALTER TABLE public.production_runs ADD COLUMN target_branch_id bigint references public.branches(id) on delete restrict;
ALTER TABLE public.production_runs ADD COLUMN ingredients_override jsonb;

UPDATE public.production_runs SET target_branch_id = branch_id WHERE target_branch_id IS NULL;
ALTER TABLE public.production_runs ALTER COLUMN target_branch_id SET NOT NULL;
